...
| 74.41 | viewarmywindow | `?WindowHandler@TViewArmyWindow@@UAEHPAVmessa..` | inliner (predict-inline) | 664 | 167 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 2 over-inline (22 name-unresolvable pair(s) discounted) |
...
| 75.10 | hero | `?GiveArtifact@hero@@QAEEPBUtype_artifact@@EE..` | inliner (predict-inline) | 140 | 45 | callee expanded on one side only (A8/A9/A12): 3 under-inline (9 name-unresolvable pair(s) discounted) |
...
| 75.55 | cmbtmgr | `?place_obstacle@combatManager@@QAEEH@Z` | inliner (predict-inline) | 169 | 47 | callee expanded on one side only (A8/A9/A12): 1 under-inline (3 name-unresolvable pair(s) discounted) |
...
| 77.38 | advmgr | `?DoAdvCommand@advManager@@QAEPAVNewmapCell@@..` | control-flow (why-branch) | 765 | 11 | loop-form / merged-return placement / case order (D1-D9) |
...
| 78.84 | game | `??1game@@QAE@XZ` | inliner (predict-inline) | 178 | 0 | callee expanded on one side only (A8/A9/A12): 2 over-inline (16 name-unresolvable pair(s) discounted) |
...
| 82.85 | advmgr | `?ShowRoute@advManager@@QAEXHHH@Z` | register-homing (why-reg) | 257 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 83.31 | advmgr | `?ViewPuzzle@advManager@@QAEXXZ` | register-homing (why-reg) | 121 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 83.50 | advmgr | `?ProcessHover@advManager@@QAEHHH@Z` | inliner (predict-inline) | 492 | 105 | callee expanded on one side only (A8/A9/A12): 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 84.51 | armygrp | `?get_luck_description@armyGroup@@QBE?AV?$bas..` | control-flow (why-branch) | 134 | 55 | loop-form / merged-return placement / case order (D1-D9) |
...
| 87.27 | hero | `?HeroFn_004DC100@hero@@QAEXJ@Z` | inliner (predict-inline) | 70 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (6 name-unresolvable pair(s) discounted) |
...
| 87.65 | findpath | `?FindCombatPath@searchArray@@QAEEPBVarmy@@JJ..` | control-flow (why-branch) | 340 | 22 | loop-form / merged-return placement / case order (D1-D9) |
...
| 88.13 | advmgr | `?SetTownContext@advManager@@QAEXHEE@Z` | register-homing (why-reg) | 58 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 89.52 | advmgr | `?ProcessWaitingHover@advManager@@QAEHHH@Z` | register-homing (why-reg) | 116 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 89.69 | ai | `?choose_melee_target@combatManager@@QAEEPBVa..` | inliner (predict-inline) | 337 | 28 | callee expanded on one side only (A8/A9/A12): 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 89.81 | army | `?WalkTo@army@@QAEEHE@Z` | control-flow (why-branch) | 152 | 8 | loop-form / merged-return placement / case order (D1-D9) |
...
| 90.81 | viewarmywindow | `??0TViewArmyWindow@@QAE@PBVarmy@@HHE@Z` | inliner (predict-inline) | 174 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 2 over-inline (26 name-unresolvable pair(s) discounted) |
...
| 91.07 | army | `?spell_is_valid_on_target@@YIEHPBVarmy@@@Z` | inliner (predict-inline) | 84 | 28 | callee expanded on one side only (A8/A9/A12): 1 over-inline |
...
| 91.38 | armygrp | `?get_morale_description@armyGroup@@QBE?AV?$b..` | inliner (predict-inline) | 407 | 94 | callee expanded on one side only (A8/A9/A12): 1 under-inline (34 name-unresolvable pair(s) discounted) |
| 91.46 | army | `?attack_wall@army@@QAEXW4TWallTargetId@@J@Z` | register-homing (why-reg) | 155 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 91.65 | hero | `?get_morale_description@hero@@QBE?AV?$basic_..` | inliner (predict-inline) | 104 | 76 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (31 name-unresolvable pair(s) discounted) |
| 91.71 | army | `?Turn@army@@QAEXE@Z` | register-homing (why-reg) | 16 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 91.89 | mapcell | `?Save@NewfullMap@@QAEHPAVTAbstractFile@@HE@Z` | inliner (predict-inline) | 116 | 63 | callee expanded on one side only (A8/A9/A12): 2 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 92.12 | advmgr | `?SetInitialMapOrigin@advManager@@QAEXXZ` | register-homing (why-reg) | 29 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 92.15 | quickherowindow | `??0TQuickHeroWindow@@QAE@PAVhero@@W4TViewLev..` | inliner (predict-inline) | 259 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (38 name-unresolvable pair(s) discounted) |
...
| 92.20 | mapcell | `?Load@NewfullMap@@QAEHPAVTAbstractFile@@HEH@Z` | inliner (predict-inline) | 53 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline (27 name-unresolvable pair(s) discounted) |
| 92.21 | army | `?compute_attacker_bonus@army@@QBEHHEPAV1@EJ@Z` | inliner (predict-inline) | 172 | 58 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (5 name-unresolvable pair(s) discounted) |
| 92.37 | game | `?Load@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 488 | 62 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 2 over-inline (27 name-unresolvable pair(s) discounted) |
...
| 92.70 | town | `?show_building_rewards@@YIXPBVtown@@PAV?$vec..` | inliner (predict-inline) | 18 | 20 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (5 name-unresolvable pair(s) discounted) |
...
| 92.94 | advmgr | `?TownQuickView@advManager@@QAEXHHHE@Z` | inliner (predict-inline) | 141 | 0 | callee expanded on one side only (A8/A9/A12): 2 over-inline (20 name-unresolvable pair(s) discounted) |
...
| 93.13 | townmgr | `?SetCommandAndText@type_garrison_base_window..` | register-homing (why-reg) | 84 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 93.16 | mainmenu | `?MainMenuHandler@@YIHAAVmessage@@@Z` | inliner (predict-inline) | 95 | 9 | callee expanded on one side only (A8/A9/A12): 1 under-inline (8 name-unresolvable pair(s) discounted) |
...
| 93.23 | town | `?show_creature_rewards@@YIXPBVtown@@PAV?$vec..` | inliner (predict-inline) | 20 | 20 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 93.44 | spells | `?SummonElemental@combatManager@@QAEXHW4TCrea..` | inliner (predict-inline) | 17 | 29 | callee expanded on one side only (A8/A9/A12): 1 under-inline (5 name-unresolvable pair(s) discounted) |
...
| 93.71 | hero | `?get_luck_description@hero@@QBE?AV?$basic_st..` | inliner (predict-inline) | 84 | 66 | callee expanded on one side only (A8/A9/A12): 2 under-inline (33 name-unresolvable pair(s) discounted) |
| 93.76 | advmgr | `?GetSoundId@advManager@@QAE?AW4e_looping_sou..` | control-flow (why-branch) | 475 | 42 | loop-form / merged-return placement / case order (D1-D9) |
...
| 93.90 | spells | `?Armageddon@combatManager@@QAEXHH@Z` | register-homing (why-reg) | 255 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 93.94 | advmgr | `?SetRolloverText@advManager@@QAEXPAVNewmapCe..` | inliner (predict-inline) | 717 | 350 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 94.13 | hero | `?get_skill_award@@YI?AW4TSecondarySkill@@PBV..` | control-flow (why-branch) | 21 | 9 | loop-form / merged-return placement / case order (D1-D9) |
...
| 94.45 | game | `?Save@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 279 | 14 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (15 name-unresolvable pair(s) discounted) |
...
| 94.74 | army | `?get_total_combat_value@army@@QBEJJJ@Z` | register-homing (why-reg) | 6 | 2 | register-homing knob (B-family) |
...
| 94.85 | advmgr | `?QuickInfo@advManager@@QAEXHHH@Z` | control-flow (why-branch) | 727 | 398 | loop-form / merged-return placement / case order (D1-D9) |
| 94.86 | mapcell | `?readMapObjects@NewfullMap@@QAEHPAVTAbstract..` | inliner (predict-inline) | 190 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (36 name-unresolvable pair(s) discounted) |
...
| 95.88 | mapcell | `??1NewfullMap@@QAE@XZ` | inliner (predict-inline) | 16 | 0 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (14 name-unresolvable pair(s) discounted) |
...
| 96.47 | mapcell | `?readMonsterData@NewfullMap@@QAEHPAVTAbstrac..` | inliner (predict-inline) | 122 | 1 | callee expanded on one side only (A8/A9/A12): 1 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 96.96 | game | `?ViewArmy@game@@QAEXAAVarmyGroup@@HPBVhero@@..` | inliner (predict-inline) | 28 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (3 name-unresolvable pair(s) discounted) |
| 96.98 | mapcell | `?readObject@NewfullMap@@QAEHPAVTAbstractFile..` | register-homing (why-reg) | 306 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 97.24 | game | `?ConvertObject@game@@QAEXPAVNewmapCell@@@Z` | inliner (predict-inline) | 133 | 2 | callee expanded on one side only (A8/A9/A12): 1 over-inline (5 name-unresolvable pair(s) discounted) |
...
| 97.39 | townmgr | `?WindowHandler@TMageGuildWindow@@UAEHPAVmess..` | register-homing (why-reg) | 10 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 97.47 | townmgr | `?handle_mage_guild_click@townManager@@QAEXXZ` | control-flow (why-branch) | 13 | 28 | loop-form / merged-return placement / case order (D1-D9) |
| 97.51 | seerhut | `?save@TQuestGuard@@QAEHPAVTAbstractFile@@@Z` | register-homing (why-reg) | 5 | 0 | spill to dead-parameter slot (B4) |
...
| 97.80 | advmgr | `?Open@advManager@@UAEHH@Z` | control-flow (why-branch) | 76 | 2 | loop-form / merged-return placement / case order (D1-D9) |
| 97.81 | game | `?save@playerData@@QAEHPAVTAbstractFile@@@Z` | register-homing (why-reg) | 63 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 98.14 | cmbtmgr | `?SetupAndLoadObstacles@combatManager@@QAEXXZ` | register-homing (why-reg) | 38 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 98.47 | campaignwindow | `??0TCampaignWindow@@QAE@EH@Z` | register-homing (why-reg) | 189 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 98.62 | army | `?LoadResources@army@@QAEXXZ` | register-homing (why-reg) | 117 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
| 98.68 | hero | `?IsInIdentifyRange@hero@@QAEEPBUtype_point@@..` | register-homing (why-reg) | 2 | 0 | register-homing knob (B-family) |
| 98.75 | bottomviewsubwindow | `??0TBottomViewTown@@QAE@PAVheroWindow@@@Z` | inliner (predict-inline) | 81 | 0 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 5 over-inline (38 name-unresolvable pair(s) discounted) |
...
| 98.88 | ai_tactical | `?cast_spell@type_AI_spellcaster@@QAEEE@Z` | control-flow (why-branch) | 8 | 8 | loop-form / merged-return placement / case order (D1-D9) |
...
| 98.98 | army | `?ComputeAttackerDamageBonuses@army@@QBEHHEPA..` | register-homing (why-reg) | 26 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 99.04 | army | `?can_cast_spell@army@@QBEEJ@Z` | control-flow (why-branch) | 35 | 46 | loop-form / merged-return placement / case order (D1-D9) |
| 99.10 | advmgr | `?MoreTreesNear@advManager@@QAEHUtype_point@@..` | control-flow (why-branch) | 121 | 4 | loop-form / merged-return placement / case order (D1-D9) |
...
| 99.43 | cmbtmgr | `?Open@combatManager@@UAEHH@Z` | unclassified | 8 | 0 | run why-reg / why-branch for the full search |
| 99.46 | command | `?DoVictory@combatManager@@QAEXH@Z` | register-homing (why-reg) | 12 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 99.55 | army | `?SetSpellInfluence@army@@QAEXHHHPBVhero@@@Z` | control-flow (why-branch) | 125 | 7 | loop-form / merged-return placement / case order (D1-D9) |
...
| 99.65 | cmbtmgr | `?SetNextArmy@combatManager@@QAEXHH@Z` | inliner (predict-inline) | 39 | 0 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 5 over-inline (12 name-unresolvable pair(s) discounted) |
| 99.66 | townmgr | `??0THallWindow@@QAE@H@Z` | inliner (predict-inline) | 42 | 2 | callee expanded on one side only (A8/A9/A12): 12 under-inline, 12 over-inline (223 name-unresolvable pair(s) discounted) |
...
| 99.78 | spells | `?SpellCastWorkChance@combatManager@@QAEMHJPB..` | unclassified | 33 | 0 | run why-reg / why-branch for the full search |
...
| 99.96 | advmgr | `?MonsterQuickView@advManager@@QAEXPBVNewmapC..` | inliner (predict-inline) | 22 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (2 name-unresolvable pair(s) discounted) |
...
| 99.98 | seerhut | `?GetQuestDescription@type_monster_quest@@UAE..` | unclassified | 2 | 0 | run why-reg / why-branch for the full search |
| 99.98 | townmgr | `?WindowHandler@TShipWindow@@UAEHPAVmessage@@..` | register-homing (why-reg) | 4 | 0 | register-homing knob (B-family) |
| 99.99 | seerhut | `?GetRequirementText@type_monster_quest@@UAE?..` | unclassified | 2 | 0 | run why-reg / why-branch for the full search |
...
| 100.00 | spells | `?DoBolt@combatManager@@QAEXHHHHHHHHHHHHHHHHH..` | register-homing (why-reg) | 2 | 0 | register-homing knob (B-family) |
