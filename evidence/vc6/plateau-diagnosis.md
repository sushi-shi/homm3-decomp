...
| 62.48 | singleselectionwindow | `?Tick@CNewPlayerUpdateProc@@UAEXXZ` | control-flow (why-branch) | 208 | 23 | loop-form / merged-return placement / case order (D1-D9) |
...
| 70.65 | game | `?LoadMap@game@@QAE_NPAVTAbstractFile@@@Z` | inliner (predict-inline) | 662 | 74 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 8 over-inline (14 name-unresolvable pair(s) discounted) |
...
| 72.94 | dxplay | `?FlushReceiveQueue@CDPlay@@UAEEXZ` | control-flow (why-branch) | 96 | 19 | loop-form / merged-return placement / case order (D1-D9) |
| 73.66 | ai_player | `?buy_creatures@type_AI_player@@QAEXPAVhero@@..` | inliner (predict-inline) | 463 | 49 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 75.10 | hero | `?GiveArtifact@hero@@QAEEPBUtype_artifact@@EE..` | inliner (predict-inline) | 140 | 45 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 75.38 | ai_player | `?consider_hiring@@YIEJPAVhero@@@Z` | inliner (predict-inline) | 276 | 40 | callee expanded on one side only (A8/A9/A12): 1 over-inline |
| 75.41 | hero | `?WindowHandler@THeroScreenWindow@@UAEHPAVmes..` | inliner (predict-inline) | 1104 | 342 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 13 over-inline (15 name-unresolvable pair(s) discounted) |
...
| 78.12 | events | `?DoEventArtifact@advManager@@QAEXPAVhero@@PA..` | inliner (predict-inline) | 167 | 6 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 1 over-inline (5 name-unresolvable pair(s) discounted) |
...
| 78.84 | game | `??1game@@QAE@XZ` | inliner (predict-inline) | 178 | 0 | callee expanded on one side only (A8/A9/A12): 2 over-inline (9 name-unresolvable pair(s) discounted) |
...
| 79.25 | swapmgr | `?SwapMons@swapManager@@QAEXXZ` | control-flow (why-branch) | 51 | 30 | loop-form / merged-return placement / case order (D1-D9) |
| 79.66 | events | `?GiveBlackBoxReward@advManager@@QAE_NPBDPAVh..` | inliner (predict-inline) | 1022 | 170 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 6 over-inline (73 name-unresolvable pair(s) discounted) |
...
| 81.35 | ai_player | `?can_trade_resources@type_AI_player@@QAE_NPB..` | control-flow (why-branch) | 459 | 7 | loop-form / merged-return placement / case order (D1-D9) |
| 81.36 | remote | `?WaitForReadyToPlayMsg@@YIXXZ` | inliner (predict-inline) | 98 | 23 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 2 over-inline |
...
| 83.36 | game | `?NextPlayer@game@@QAEXXZ` | inliner (predict-inline) | 391 | 108 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 83.38 | multiplayerwindow | `?OnWidgetDeselect@CMPInputDlg@@UAEHHPAE@Z` | control-flow (why-branch) | 8 | 2 | loop-form / merged-return placement / case order (D1-D9) |
...
| 86.09 | game | `?read_map_hero_setups@game@@QAEXPAVTAbstract..` | inliner (predict-inline) | 56 | 3 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 86.14 | philai | `?value_of_obelisk@@YIHPAVNewmapCell@@J@Z` | inliner (predict-inline) | 38 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
...
| 86.57 | tradpost | `?WindowHandler@TSellArtifactWindow@@UAEHPAVm..` | control-flow (why-branch) | 267 | 48 | loop-form / merged-return placement / case order (D1-D9) |
| 86.65 | tradpost | `?Update@TTradeResourceWindow@@QAEXE@Z` | control-flow (why-branch) | 264 | 9 | loop-form / merged-return placement / case order (D1-D9) |
...
| 86.93 | game | `?RandomizeEvents@game@@QAEXXZ` | inliner (predict-inline) | 1037 | 67 | callee expanded on one side only (A8/A9/A12): 12 under-inline, 15 over-inline (18 name-unresolvable pair(s) discounted) |
...
| 87.22 | philai | `?ValueOfScroll@@YIHPBVhero@@PAVNewmapCell@@@Z` | register-homing (why-reg) | 45 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 87.50 | philai | `?ValueOfTreasure@@YIHPBVhero@@@Z` | register-homing (why-reg) | 33 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 88.51 | philai | `?value_of_war_factory@@YIJPBVhero@@W4TArtifa..` | register-homing (why-reg) | 23 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 88.61 | events | `?monsters_give_reward@advManager@@QAEXPAVher..` | control-flow (why-branch) | 52 | 2 | loop-form / merged-return placement / case order (D1-D9) |
...
| 88.82 | tradpost | `?Update@TBuyArtifactWindow@@QAEXE@Z` | register-homing (why-reg) | 275 | 2 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 89.10 | seerhut | `?DoProposalDialog@type_artifact_quest@@UAEXP..` | inliner (predict-inline) | 58 | 1 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (13 name-unresolvable pair(s) discounted) |
...
| 89.48 | philai | `?DoAI@philAI@@QAEXH@Z` | inliner (predict-inline) | 127 | 32 | callee expanded on one side only (A8/A9/A12): 2 over-inline (5 name-unresolvable pair(s) discounted) |
...
| 90.16 | singleselectionwindow | `?HandleNetMsg@TSingleSelectionWindow@@QAEEPA..` | inliner (predict-inline) | 318 | 43 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 4 over-inline (16 name-unresolvable pair(s) discounted) |
...
| 90.30 | combatwindow | `?CheckCombatCheatCode@@YIXAAV?$basic_string@..` | inliner (predict-inline) | 86 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline |
...
| 90.92 | remote | `??1CWaitForReadyPlayersDlg@@UAE@XZ` | inliner (predict-inline) | 32 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
...
| 91.46 | army | `?attack_wall@army@@QAEXW4TWallTargetId@@J@Z` | inliner (predict-inline) | 155 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 92.41 | game | `?Load@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 539 | 62 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 3 over-inline (5 name-unresolvable pair(s) discounted) |
...
| 92.56 | philai | `?ValueOfRallyFlag@@YIHPBVhero@@PAJ@Z` | register-homing (why-reg) | 10 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 92.76 | ai_player | `?AI_get_value_of_artifact@@YIJUtype_artifact..` | control-flow (why-branch) | 132 | 5 | loop-form / merged-return placement / case order (D1-D9) |
...
| 93.06 | armygrp | `?get_morale_description@armyGroup@@QBE?AV?$b..` | inliner (predict-inline) | 362 | 94 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 4 over-inline (22 name-unresolvable pair(s) discounted) |
...
| 93.44 | spells | `?SummonElemental@combatManager@@QAEXHW4TCrea..` | inliner (predict-inline) | 17 | 29 | callee expanded on one side only (A8/A9/A12): 1 under-inline (2 name-unresolvable pair(s) discounted) |
...
| 93.73 | philai | `?buy_artifacts@@YIXPAVhero@@PAW4TArtifact@@J..` | inliner (predict-inline) | 38 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 94.08 | event_record | `?record_move@game@@QAEXPAVhero@@HUtype_point..` | inliner (predict-inline) | 29 | 22 | callee expanded on one side only (A8/A9/A12): 1 over-inline (10 name-unresolvable pair(s) discounted) |
...
| 94.20 | philai | `?ValueOfMine@@YIHPBVhero@@PAVNewmapCell@@@Z` | control-flow (why-branch) | 37 | 4 | loop-form / merged-return placement / case order (D1-D9) |
| 94.23 | event_record | `?replay@type_record_player_death@@UAEXE@Z` | unclassified | 8 | 0 | run why-reg / why-branch for the full search |
...
| 94.86 | mapcell | `?readMapObjects@NewfullMap@@QAEHPAVTAbstract..` | inliner (predict-inline) | 190 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (28 name-unresolvable pair(s) discounted) |
...
| 95.03 | event_record | `?record_claim_mine@game@@QAEXJJ@Z` | inliner (predict-inline) | 27 | 22 | callee expanded on one side only (A8/A9/A12): 1 over-inline (11 name-unresolvable pair(s) discounted) |
...
| 95.15 | philai | `?ValueOfSirens@@YIHPBVhero@@@Z` | register-homing (why-reg) | 31 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 95.39 | singleselectionwindow | `?NewPlayer@CNewPlayerUpdateMan@@QAEXK@Z` | unclassified | 1 | 0 | run why-reg / why-branch for the full search |
...
| 96.40 | game | `?Save@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 262 | 2 | callee expanded on one side only (A8/A9/A12): 1 under-inline (5 name-unresolvable pair(s) discounted) |
...
| 96.80 | spellbookwindow | `?get_spell_description@TSpellbookWindow@@AAE..` | inliner (predict-inline) | 21 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline (10 name-unresolvable pair(s) discounted) |
...
| 96.94 | command | `?automate_catapult@combatManager@@QAEEXZ` | control-flow (why-branch) | 60 | 4 | loop-form / merged-return placement / case order (D1-D9) |
...
| 97.05 | tradpost | `?SetRolloverText@TSellCreatureWindow@@QAEXH@Z` | register-homing (why-reg) | 137 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 97.75 | philai | `?wants_skill@@YIEPBVhero@@HH@Z` | control-flow (why-branch) | 17 | 2 | loop-form / merged-return placement / case order (D1-D9) |
...
| 97.87 | philai | `?GetTurnAIVars@philAI@@QAEXH@Z` | inliner (predict-inline) | 2 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
...
| 98.11 | event_record | `?record_claim_town@game@@QAEXJJ@Z` | inliner (predict-inline) | 5 | 3 | callee expanded on one side only (A8/A9/A12): 1 over-inline (12 name-unresolvable pair(s) discounted) |
| 98.12 | command | `?automate_first_aid_tent@combatManager@@QAEE..` | register-homing (why-reg) | 18 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 98.17 | event_record | `?record_teleport@game@@QAEXPAVhero@@Utype_po..` | inliner (predict-inline) | 5 | 3 | callee expanded on one side only (A8/A9/A12): 1 over-inline (11 name-unresolvable pair(s) discounted) |
| 98.18 | event_record | `?record_show_boat@game@@QAEXPAVboat@@Utype_p..` | inliner (predict-inline) | 5 | 3 | callee expanded on one side only (A8/A9/A12): 1 over-inline (11 name-unresolvable pair(s) discounted) |
...
| 98.21 | event_record | `?replay@type_record_shroud@@UAEXE@Z` | register-homing (why-reg) | 2 | 0 | register-homing knob (B-family) |
| 98.25 | tradpost | `?Update@TSellArtifactWindow@@QAEXE@Z` | register-homing (why-reg) | 46 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 98.30 | event_record | `?record_show_hero@game@@QAEXPAVhero@@CUtype_..` | register-homing (why-reg) | 6 | 0 | register-homing knob (B-family) |
| 98.32 | remote | `?HandleMPlayerLaunch@@YIEXZ` | unclassified | 20 | 0 | run why-reg / why-branch for the full search |
| 98.34 | seerhut | `?SetDefaultText@type_monster_quest@@UAEXXZ` | inliner (predict-inline) | 25 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline (17 name-unresolvable pair(s) discounted) |
...
| 98.57 | armygrp | `?GetMorale@armyGroup@@QAEHPBVhero@@PBVtown@@..` | inliner (predict-inline) | 13 | 0 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 4 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 98.70 | event_record | `?record_hide_hero@game@@QAEXPAVhero@@DE@Z` | register-homing (why-reg) | 10 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 98.71 | remote | `?OnPlayerDropUpdateMsg@@YIXK@Z` | inliner (predict-inline) | 17 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 98.79 | tradpost | `?Update@TSellCreatureWindow@@QAEX_N@Z` | register-homing (why-reg) | 21 | 0 | register-homing knob (B-family) |
...
| 98.91 | drawing | `?DrawFrame@combatManager@@QAEXEEEHEE@Z` | register-homing (why-reg) | 28 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 98.99 | game | `?add_garrison_hero@playerData@@QAEEPAVtown@@..` | inliner (predict-inline) | 2 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 99.11 | recruit | `?Main@recruitUnit@@UAEHAAVmessage@@@Z` | inliner (predict-inline) | 85 | 0 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 4 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 99.15 | events | `?DoCustomArtifact@advManager@@QAEXPAVhero@@P..` | register-homing (why-reg) | 12 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 99.25 | singleselectionwindow | `?OnUpdatePlayerPosMsg@TSingleSelectionWindow..` | unclassified | 1 | 0 | run why-reg / why-branch for the full search |
...
| 99.33 | game | `?ClaimTown@game@@QAEXHHEE@Z` | control-flow (why-branch) | 4 | 2 | loop-form / merged-return placement / case order (D1-D9) |
...
| 99.44 | puzzlewindow | `??0type_AI_puzzle_tile@@QAE@PAVNewmapCell@@U..` | unclassified | 4 | 0 | run why-reg / why-branch for the full search |
...
| 99.62 | singleselectionwindow | `?OnGameTransmitInitMsg@TSingleSelectionWindo..` | register-homing (why-reg) | 12 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 99.65 | cmbtmgr | `?SetNextArmy@combatManager@@QAEXHH@Z` | inliner (predict-inline) | 39 | 0 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 6 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 99.66 | singleselectionwindow | `?SetCurrentMap@TSingleSelectionWindow@@QAEXH..` | register-homing (why-reg) | 153 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 99.73 | game | `?PerWeek@game@@QAEXXZ` | control-flow (why-branch) | 71 | 6 | loop-form / merged-return placement / case order (D1-D9) |
...
| 99.91 | game | `?SaveGame@game@@QAEEPBDEEEE@Z` | register-homing (why-reg) | 52 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 99.93 | philai | `?value_of_experience@@YIMPBVhero@@PBVarmyGro..` | register-homing (why-reg) | 4 | 0 | register-homing knob (B-family) |
...
| 99.94 | philai | `?buy_siege_engine@@YIXPAVhero@@PAVtown@@W4ty..` | register-homing (why-reg) | 14 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 99.95 | game | `?LoadMinePool@game@@QAEHPAVTAbstractFile@@H@Z` | unclassified | 4 | 0 | run why-reg / why-branch for the full search |
| 99.95 | ai_player | `?value_of_hiring@@YIJPAVtown@@PAVhero@@PAVse..` | register-homing (why-reg) | 48 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
| 99.95 | events | `?DoEventPrison@advManager@@QAEXPAVhero@@PAVN..` | register-homing (why-reg) | 2 | 0 | register-homing knob (B-family) |
| 99.95 | drawing | `?DrawWallAt@combatManager@@QAEXHH@Z` | register-homing (why-reg) | 4 | 0 | register-homing knob (B-family) |
...
| 99.96 | ai_combat | `?AI_value_of_combat@@YIJPBVhero@@0ABVarmyGro..` | inliner (predict-inline) | 8 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
...
| 99.96 | singleselectionpopups | `?handle_message@CSingleSelPopup@@UAEHAAVmess..` | inliner (predict-inline) | 2 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
...
| 99.98 | seerhut | `?getValue@TSeerReward@@QAEHPBVhero@@@Z` | inliner (predict-inline) | 43 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
| 99.99 | philai | `?AI_set_hero_bonuses@@YIXPAVhero@@@Z` | unclassified | 6 | 0 | run why-reg / why-branch for the full search |
| 99.99 | events | `?DispatchEvent@advManager@@QAEXPAVhero@@PAVN..` | control-flow (why-branch) | 291 | 7 | loop-form / merged-return placement / case order (D1-D9) |
...
| 100.00 | army | `?do_attack@army@@QAEEPAV1@H@Z` | register-homing (why-reg) | 4 | 0 | register-homing knob (B-family) |
