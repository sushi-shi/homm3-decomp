<!-- # generator: homm3.vc6.report | # date: 2026-09-04 | # ANALYSIS OUTPUT, NOT RETAIL EVIDENCE - regenerate, never hand-edit | plateaus in [50.0, 99.999%); base-vs-delinked-target diagnosis, no recompiles -->
...
- **224** register-homing (why-reg)
- **215** inliner (predict-inline)
- **83** control-flow (why-branch)
- **33** unclassified
...
| 55.79 | customcampaign | `?Load@SCampaign@@QAEXPAVTAbstractFile@@H@Z` | inliner (predict-inline) | 1159 | 163 | callee expanded on one side only (A8/A9/A12): 8 under-inline, 15 over-inline (8 name-unresolvable pair(s) discounted) |
| 60.55 | game | `?Load@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 1229 | 138 | callee expanded on one side only (A8/A9/A12): 65 under-inline, 1 over-inline (3 name-unresolvable pair(s) discounted) |
| 60.93 | singleselectionwindow | `?CreateFilterWidgets@TSingleSelectionWindow@..` | inliner (predict-inline) | 2237 | 495 | callee expanded on one side only (A8/A9/A12): 56 under-inline (123 name-unresolvable pair(s) discounted) |
...
| 70.65 | game | `?LoadMap@game@@QAE_NPAVTAbstractFile@@@Z` | inliner (predict-inline) | 662 | 74 | callee expanded on one side only (A8/A9/A12): 9 under-inline, 11 over-inline (9 name-unresolvable pair(s) discounted) |
...
| 74.76 | rmg_terrain | `?PaintTransitions@TRmgTerrainPainter@@QAEXXZ` | inliner (predict-inline) | 721 | 76 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 5 over-inline (10 name-unresolvable pair(s) discounted) |
| 75.00 | singleselectionwindow | `??0TSingleSelectionWindow@@QAE@H@Z` | inliner (predict-inline) | 2820 | 283 | callee expanded on one side only (A8/A9/A12): 27 under-inline, 45 over-inline (207 name-unresolvable pair(s) discounted) |
...
| 75.24 | seerhut | `?DoProgressDialog@type_artifact_quest@@UAEXXZ` | inliner (predict-inline) | 64 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (2 name-unresolvable pair(s) discounted) |
...
| 75.84 | seerhut | `?DoProgressDialog@type_skill_quest@@UAEXXZ` | inliner (predict-inline) | 88 | 2 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (2 name-unresolvable pair(s) discounted) |
...
| 76.14 | overview | `?WindowHandler@TOverviewWindow@@UAEHPAVmessa..` | inliner (predict-inline) | 653 | 205 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 7 over-inline |
...
| 76.87 | ai_player | `?AI_choose_destination@@YIHPAVhero@@JAAUHero..` | inliner (predict-inline) | 884 | 132 | callee expanded on one side only (A8/A9/A12): 2 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 76.92 | game | `?Save@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 879 | 20 | callee expanded on one side only (A8/A9/A12): 26 under-inline (3 name-unresolvable pair(s) discounted) |
| 76.94 | rmg | `?CreateSubterraneanGate@type_random_map_gene..` | inliner (predict-inline) | 884 | 81 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 4 over-inline (10 name-unresolvable pair(s) discounted) |
...
| 78.28 | overview | `??0TOverviewWindow@@QAE@XZ` | inliner (predict-inline) | 1367 | 193 | callee expanded on one side only (A8/A9/A12): 11 under-inline, 3 over-inline (93 name-unresolvable pair(s) discounted) |
...
| 79.32 | singleselectionwindow | `??0GameSelectionHeadersStruct@@QAE@XZ` | inliner (predict-inline) | 120 | 5 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 80.59 | multiplayerwindow | `??0TMultiPlayerWindow@@QAE@XZ` | inliner (predict-inline) | 695 | 87 | callee expanded on one side only (A8/A9/A12): 13 over-inline (62 name-unresolvable pair(s) discounted) |
| 80.93 | hero | `?update_spell_list@hero@@QAEXXZ` | register-homing (why-reg) | 95 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
| 80.98 | campaignbrief | `?CampaignBriefHandler@@YIHAAVmessage@@@Z` | (diag error: no shared public text symbol in built objects) | - | - | - |
| 81.03 | ai_player | `?can_trade_resources@type_AI_player@@QAE_NPB..` | inliner (predict-inline) | 455 | 5 | callee expanded on one side only (A8/A9/A12): 6 under-inline (19 name-unresolvable pair(s) discounted) |
...
| 81.30 | singleselectionwindow | `?OnGameHeaderInfoInitMsg@TSingleSelectionWin..` | inliner (predict-inline) | 221 | 10 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 2 over-inline (13 name-unresolvable pair(s) discounted) |
...
| 82.40 | drawing | `?show_creature_spell_error@combatManager@@AA..` | inliner (predict-inline) | 125 | 151 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline |
...
| 82.55 | search | `?BuildPath@searchArray@@QAEHPBVhero@@J@Z` | inliner (predict-inline) | 151 | 17 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 2 over-inline (2 name-unresolvable pair(s) discounted) |
...
| 83.50 | advmgr | `?ProcessHover@advManager@@QAEHHH@Z` | control-flow (why-branch) | 492 | 105 | loop-form / merged-return placement / case order (D1-D9) |
...
| 84.03 | event_record | `?load@type_record_shroud@@UAEEPAVTAbstractFi..` | inliner (predict-inline) | 74 | 11 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 84.11 | resourcemanager | `?Open@ResourceManager@@YI_N_N0PAH@Z` | inliner (predict-inline) | 164 | 24 | callee expanded on one side only (A8/A9/A12): 1 under-inline (5 name-unresolvable pair(s) discounted) |
...
| 84.59 | ai_player | `?make_gift@type_AI_player@@QAEXJ@Z` | inliner (predict-inline) | 279 | 0 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (7 name-unresolvable pair(s) discounted) |
| 84.78 | event_record | `?ResetVisibility@game@@QAEXHHHHH@Z` | inliner (predict-inline) | 200 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (2 name-unresolvable pair(s) discounted) |
| 84.83 | ai_player | `?AI_AttemptMove@@YIXPAVhero@@AAUHeroDestinat..` | inliner (predict-inline) | 176 | 42 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 85.65 | event_record | `?SetVisibility@game@@QAEXHHHHHE@Z` | inliner (predict-inline) | 190 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (2 name-unresolvable pair(s) discounted) |
| 85.77 | campaignbrief | `??0TCampaignBrief@@QAE@EE@Z` | inliner (predict-inline) | 1053 | 77 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (73 name-unresolvable pair(s) discounted) |
...
| 86.06 | singleselectionwindow | `?OnPlayerPosClick@TSingleSelectionWindow@@QA..` | inliner (predict-inline) | 93 | 40 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline |
...
| 86.37 | advmgr | `?Close@advManager@@UAEXXZ` | control-flow (why-branch) | 151 | 4 | loop-form / merged-return placement / case order (D1-D9) |
...
| 86.66 | viewarmywindow | `?create_spell_influence_widgets@TViewArmyWin..` | inliner (predict-inline) | 165 | 14 | callee expanded on one side only (A8/A9/A12): 1 under-inline (10 name-unresolvable pair(s) discounted) |
| 86.67 | adventuremapwindow | `?SetSleepImage@TAdventureMapWindow@@QAEXH@Z` | inliner (predict-inline) | 145 | 24 | callee expanded on one side only (A8/A9/A12): 2 under-inline (8 name-unresolvable pair(s) discounted) |
...
| 86.99 | hero | `?can_summon_boat@hero@@QBEEXZ` | register-homing (why-reg) | 41 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 87.06 | townmgr | `?SetupThievesGuild@TThievesGuildWindow@@QAEX..` | inliner (predict-inline) | 1014 | 120 | callee expanded on one side only (A8/A9/A12): 2 under-inline (55 name-unresolvable pair(s) discounted) |
| 87.07 | singleselectionwindow | `?GetHeaders@TSingleSelectionWindow@@QAEXPAV?..` | inliner (predict-inline) | 88 | 21 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (9 name-unresolvable pair(s) discounted) |
| 87.11 | ai | `?find_attack_hexes@@YIXPBVarmy@@JJJJPBVsearc..` | control-flow (why-branch) | 110 | 29 | loop-form / merged-return placement / case order (D1-D9) |
...
| 87.28 | singleselectionpopups | `?CreateWin@CTownDlg@@QAEEPAVCSprite@@HW4TTow..` | inliner (predict-inline) | 273 | 1 | callee expanded on one side only (A8/A9/A12): 1 under-inline (29 name-unresolvable pair(s) discounted) |
...
| 87.55 | findpath | `?PushPoint@searchArray@@QAEXPBUpathCell@@PAU..` | inliner (predict-inline) | 320 | 116 | callee expanded on one side only (A8/A9/A12): 4 under-inline (17 name-unresolvable pair(s) discounted) |
| 87.59 | advmgr | `?DrawAdvObj@advManager@@QAEXHHHHH@Z` | register-homing (why-reg) | 734 | 2 | spill to dead-parameter slot (B4) |
| 87.65 | findpath | `?FindCombatPath@searchArray@@QAEEPBVarmy@@JJ..` | inliner (predict-inline) | 340 | 22 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 87.85 | game | `??0game@@QAE@XZ` | inliner (predict-inline) | 65 | 3 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 2 over-inline (2 name-unresolvable pair(s) discounted) |
| 87.89 | university_window | `??0type_university_window@@QAE@PAVhero@@PBUt..` | inliner (predict-inline) | 760 | 55 | callee expanded on one side only (A8/A9/A12): 8 over-inline (114 name-unresolvable pair(s) discounted) |
...
| 88.62 | singleselectionwindow | `?HeaderRequested@CNewPlayerUpdateMan@@QAEXKE..` | inliner (predict-inline) | 55 | 16 | callee expanded on one side only (A8/A9/A12): 1 under-inline (8 name-unresolvable pair(s) discounted) |
...
| 88.70 | event_record | `?record_erase_object@game@@QAEXPAVNewmapCell..` | register-homing (why-reg) | 81 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 88.87 | spellbookwindow | `?GotoPage@TSpellbookWindow@@QAEXH@Z` | inliner (predict-inline) | 152 | 52 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 89.10 | seerhut | `?DoProposalDialog@type_artifact_quest@@UAEXP..` | inliner (predict-inline) | 58 | 1 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (12 name-unresolvable pair(s) discounted) |
...
| 89.43 | spells | `?InitiateSpell@combatManager@@QAEXHH@Z` | inliner (predict-inline) | 358 | 170 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 89.51 | singleselectionwindow | `?HandleNetMsg@TSingleSelectionWindow@@QAEEPA..` | inliner (predict-inline) | 346 | 43 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 5 over-inline (12 name-unresolvable pair(s) discounted) |
...
| 89.93 | customcampaign | `?InitializeCrossoverHero@ScenarioStruct@TCam..` | inliner (predict-inline) | 297 | 39 | callee expanded on one side only (A8/A9/A12): 2 over-inline (6 name-unresolvable pair(s) discounted) |
...
| 90.12 | ai_player | `?trade_resources@type_AI_player@@QAEXPBHJ@Z` | register-homing (why-reg) | 53 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 90.16 | viewarmywindow | `??0TViewArmyWindow@@QAE@PBVarmy@@HHE@Z` | inliner (predict-inline) | 174 | 46 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (24 name-unresolvable pair(s) discounted) |
...
| 90.22 | singleselectionwindow | `?OnMapFileNameMsg@TSingleSelectionWindow@@QA..` | inliner (predict-inline) | 119 | 3 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 90.26 | findpath | `?PushCombatPoint@searchArray@@QAEXHHHHH@Z` | inliner (predict-inline) | 85 | 3 | callee expanded on one side only (A8/A9/A12): 1 under-inline (10 name-unresolvable pair(s) discounted) |
...
| 90.26 | spells | `?CastSpell@combatManager@@QAEXHHHHHJ@Z` | inliner (predict-inline) | 1684 | 248 | callee expanded on one side only (A8/A9/A12): 2 over-inline (18 name-unresolvable pair(s) discounted) |
| 90.30 | advmgr | `??0advManager@@QAE@XZ` | register-homing (why-reg) | 25 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 90.30 | drawing | `?CombatMessage@combatManager@@QAEXH@Z` | inliner (predict-inline) | 337 | 106 | callee expanded on one side only (A8/A9/A12): 2 under-inline |
...
| 90.47 | viewarmywindow | `??0TViewArmyWindow@@QAE@PAVarmyGroup@@HPBVhe..` | inliner (predict-inline) | 147 | 32 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (20 name-unresolvable pair(s) discounted) |
| 90.49 | mapcell | `?NewfullMapFn_004FD950@NewfullMap@@QAEXPAVTA..` | inliner (predict-inline) | 99 | 1 | callee expanded on one side only (A8/A9/A12): 1 under-inline (11 name-unresolvable pair(s) discounted) |
...
| 90.70 | hiscore | `??0THighScoreWindow@@QAE@XZ` | inliner (predict-inline) | 170 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (16 name-unresolvable pair(s) discounted) |
...
| 90.90 | town | `?give_event_reward@town@@QAEXPBVTTownEvent@@..` | inliner (predict-inline) | 128 | 5 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 2 over-inline |
| 90.93 | ai_combat | `?choose_melee@type_AI_combat_data@@QBE_NABV1..` | inliner (predict-inline) | 283 | 2 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 91.08 | townmgr | `?BuyBuild@townManager@@QAEHHHH@Z` | inliner (predict-inline) | 703 | 61 | callee expanded on one side only (A8/A9/A12): 1 under-inline (20 name-unresolvable pair(s) discounted) |
...
| 91.22 | singleselectionwindow | `?OnWidgetDeselect@TSingleSelectionWindow@@QA..` | inliner (predict-inline) | 635 | 200 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 8 over-inline (7 name-unresolvable pair(s) discounted) |
| 91.26 | ai_player | `?calculate_reserve@type_AI_player@@QAEXXZ` | inliner (predict-inline) | 78 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (6 name-unresolvable pair(s) discounted) |
| 91.30 | bottomviewsubwindow | `??0TBottomViewResourceMessage@@QAE@PAVheroWi..` | inliner (predict-inline) | 40 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (15 name-unresolvable pair(s) discounted) |
...
| 91.56 | game | `?Read@NewSMapHeader@@QAEHPAVTAbstractFile@@H..` | inliner (predict-inline) | 322 | 50 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 5 over-inline (14 name-unresolvable pair(s) discounted) |
...
| 92.20 | mapcell | `?Load@NewfullMap@@QAEHPAVTAbstractFile@@HEH@Z` | inliner (predict-inline) | 53 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (6 name-unresolvable pair(s) discounted) |
...
| 92.57 | quickherowindow | `??0TQuickHeroWindow@@QAE@PAVhero@@W4TViewLev..` | inliner (predict-inline) | 253 | 0 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (30 name-unresolvable pair(s) discounted) |
...
| 93.01 | mapcell | `?readBlackBox@NewfullMap@@QAEHPAVTAbstractFi..` | inliner (predict-inline) | 304 | 28 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 93.10 | command | `?ProcessCombatMsg@combatManager@@QAEHAAVmess..` | inliner (predict-inline) | 293 | 256 | callee expanded on one side only (A8/A9/A12): 3 under-inline (26 name-unresolvable pair(s) discounted) |
...
| 93.63 | recruit | `?add_creature_widgets@TRecruitWindow@@QAEXJJ..` | control-flow (why-branch) | 26 | 20 | loop-form / merged-return placement / case order (D1-D9) |
...
| 93.88 | townmgr | `??0type_garrison_base_window@@QAE@PAVhero@@H..` | inliner (predict-inline) | 289 | 175 | callee expanded on one side only (A8/A9/A12): 7 over-inline (193 name-unresolvable pair(s) discounted) |
...
| 94.01 | bottomviewsubwindow | `??0TBottomViewTown@@QAE@PAVheroWindow@@@Z` | inliner (predict-inline) | 200 | 54 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 5 over-inline (34 name-unresolvable pair(s) discounted) |
...
| 94.73 | overview | `?ProcessIconSelect@game@@QAEHHE@Z` | register-homing (why-reg) | 324 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 94.76 | university_window | `?purchase_click@type_university_window@@KIHA..` | register-homing (why-reg) | 16 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 94.82 | search | `?SeedPosition@searchArray@@QAEXPAVhero@@Utyp..` | inliner (predict-inline) | 232 | 5 | callee expanded on one side only (A8/A9/A12): 1 over-inline (4 name-unresolvable pair(s) discounted) |
| 94.84 | viewwrld | `?VWDrawAdvObj@advManager@@QAEXHHHHH@Z` | register-homing (why-reg) | 293 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 94.95 | kb | `?DisplayVCWinLoss@@YI_NAAVVictoryConditionSt..` | control-flow (why-branch) | 110 | 64 | loop-form / merged-return placement / case order (D1-D9) |
| 95.00 | mapcell | `?loadBlackBox@NewfullMap@@QAEHPAVTAbstractFi..` | inliner (predict-inline) | 84 | 9 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 95.51 | spells | `?update_spell_target@@YIHJ@Z` | (diag error: no shared public text symbol in built objects) | - | - | - |
...
| 95.70 | game | `?readMapPlayerSlot@TPlayerSlotAttributes@CMa..` | inliner (predict-inline) | 128 | 1 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 3 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 95.71 | rmg | `?WriteMapHeader@type_random_map_generator@@Q..` | inliner (predict-inline) | 472 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (6 name-unresolvable pair(s) discounted) |
| 95.74 | path | `?ValidPath@army@@QAEEHE@Z` | register-homing (why-reg) | 4 | 0 | spill to dead-parameter slot (B4) |
| 95.78 | scenarioinfo | `??0CScenarioInfoDlg@@QAE@XZ` | inliner (predict-inline) | 1223 | 119 | callee expanded on one side only (A8/A9/A12): 10 under-inline (206 name-unresolvable pair(s) discounted) |
| 95.88 | mapcell | `??1NewfullMap@@QAE@XZ` | inliner (predict-inline) | 16 | 0 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 96.34 | systemoptionswindow | `??0TSystemOptionsWindow@@QAE@XZ` | inliner (predict-inline) | 502 | 158 | callee expanded on one side only (A8/A9/A12): 10 under-inline (128 name-unresolvable pair(s) discounted) |
...
| 96.36 | ai_player | `?find_all_destinations@@YIJPAVhero@@PAVsearc..` | inliner (predict-inline) | 91 | 3 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 6 over-inline (6 name-unresolvable pair(s) discounted) |
...
| 96.44 | viewwrld | `??0TViewWorldWindow@@QAE@XZ` | inliner (predict-inline) | 204 | 88 | callee expanded on one side only (A8/A9/A12): 1 over-inline (148 name-unresolvable pair(s) discounted) |
| 96.46 | overview | `?SetupNewOverviewType@game@@QAEXHE@Z` | unclassified | 14 | 0 | run why-reg / why-branch for the full search |
...
| 97.36 | army | `?CancelIndividualSpell@army@@QAEXH@Z` | inliner (predict-inline) | 54 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (6 name-unresolvable pair(s) discounted) |
...
| 97.40 | mapcell | `?readMapObjects@NewfullMap@@QAEHPAVTAbstract..` | inliner (predict-inline) | 136 | 0 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (27 name-unresolvable pair(s) discounted) |
...
| 97.46 | rmg | `?InitializeObjectGenerators@type_random_map_..` | inliner (predict-inline) | 752 | 0 | callee expanded on one side only (A8/A9/A12): 30 under-inline, 28 over-inline (226 name-unresolvable pair(s) discounted) |
...
| 97.77 | bottomviewsubwindow | `??0TBottomViewHero@@QAE@PAVheroWindow@@@Z` | inliner (predict-inline) | 86 | 1 | callee expanded on one side only (A8/A9/A12): 1 under-inline (27 name-unresolvable pair(s) discounted) |
...
| 97.79 | ai_player | `?get_value@type_school_artifact@@UBEJPBVhero..` | inliner (predict-inline) | 9 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline |
| 97.80 | advmgr | `?Open@advManager@@UAEHH@Z` | inliner (predict-inline) | 76 | 2 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (16 name-unresolvable pair(s) discounted) |
...
| 97.85 | overview | `?DoRollover@TOverviewWindow@@AAEXH@Z` | register-homing (why-reg) | 207 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 98.04 | castle | `?SetupCastle@townManager@@QAEXPAVheroWindow@..` | register-homing (why-reg) | 124 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 98.14 | cmbtmgr | `?SetupAndLoadObstacles@combatManager@@QAEXXZ` | inliner (predict-inline) | 34 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (9 name-unresolvable pair(s) discounted) |
...
| 98.21 | victorylossconditions | `?CheckForArtifactWin@VictoryConditionStruct@..` | inliner (predict-inline) | 15 | 0 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (11 name-unresolvable pair(s) discounted) |
...
| 98.35 | sacrifice_window | `??0type_skeleton_window@@QAE@PAVarmyGroup@@@Z` | inliner (predict-inline) | 48 | 24 | callee expanded on one side only (A8/A9/A12): 5 under-inline (62 name-unresolvable pair(s) discounted) |
| 98.38 | hero | `?GetHighestSchool@hero@@QBE?AW4TSpellSchool@..` | unclassified | 4 | 0 | run why-reg / why-branch for the full search |
| 98.39 | kb | `?DoCampaignWindow@@YIEXZ` | (diag error: no shared public text symbol in built objects) | - | - | - |
| 98.47 | ai | `?DoCompAI@combatManager@@QAEXH@Z` | unclassified | 1 | 0 | run why-reg / why-branch for the full search |
| 98.47 | campaignwindow | `??0TCampaignWindow@@QAE@EH@Z` | inliner (predict-inline) | 189 | 0 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (24 name-unresolvable pair(s) discounted) |
...
| 98.52 | bottomviewsubwindow | `??0TBottomViewKingdom@@QAE@PAVheroWindow@@@Z` | inliner (predict-inline) | 24 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (22 name-unresolvable pair(s) discounted) |
...
| 98.84 | quicktownwindow | `??0TQuickTownWindow@@QAE@PBVtown@@W4TViewLev..` | inliner (predict-inline) | 16 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (25 name-unresolvable pair(s) discounted) |
| 98.84 | campaignbrief | `?AddBonusIcons@TCampaignBrief@@QAEXXZ` | inliner (predict-inline) | 37 | 0 | callee expanded on one side only (A8/A9/A12): 4 under-inline (60 name-unresolvable pair(s) discounted) |
...
| 98.95 | townmgr | `??0TTownScreenWindow@@QAE@XZ` | inliner (predict-inline) | 259 | 1 | callee expanded on one side only (A8/A9/A12): 14 under-inline, 6 over-inline (239 name-unresolvable pair(s) discounted) |
...
| 99.01 | recruit | `??0TRecruitWindow@@QAE@HHHPAVrecruitUnit@@@Z` | inliner (predict-inline) | 115 | 0 | callee expanded on one side only (A8/A9/A12): 5 under-inline (122 name-unresolvable pair(s) discounted) |
| 99.05 | events | `?DoCombat@advManager@@QAEHUtype_point@@PAVhe..` | control-flow (why-branch) | 70 | 5 | loop-form / merged-return placement / case order (D1-D9) |
| 99.06 | town | `?show_creature_rewards@@YIXPBVtown@@PAV?$vec..` | unclassified | 4 | 0 | run why-reg / why-branch for the full search |
| 99.08 | townmgr | `??0townManager@@QAE@XZ` | register-homing (why-reg) | 4 | 0 | register-homing knob (B-family) |
...
| 99.11 | singleselectionpopups | `?CreateWin@CTeamAlignmentDlg@@QAEEXZ` | inliner (predict-inline) | 15 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (17 name-unresolvable pair(s) discounted) |
| 99.13 | combatcontrolsubwindow | `??0TCombatCreatureSubWindow@@QAE@HHHHPAVhero..` | inliner (predict-inline) | 34 | 50 | callee expanded on one side only (A8/A9/A12): 5 under-inline (82 name-unresolvable pair(s) discounted) |
| 99.13 | levelupwindow | `??0TLevelUpWindow@@QAE@PAVhero@@HHH@Z` | inliner (predict-inline) | 61 | 0 | callee expanded on one side only (A8/A9/A12): 3 under-inline (81 name-unresolvable pair(s) discounted) |
| 99.15 | kb | `?DoSinglePlayerWindow@@YIHXZ` | (diag error: no shared public text symbol in built objects) | - | - | - |
| 99.17 | hero | `?HeroFn_004D9B30@hero@@QAEHH@Z` | unclassified | 4 | 0 | run why-reg / why-branch for the full search |
| 99.17 | kb | `?set@type_dialog_icon@@QAEXW4EGameResource@@..` | inliner (predict-inline) | 126 | 0 | callee expanded on one side only (A8/A9/A12): 2 over-inline (55 name-unresolvable pair(s) discounted) |
...
| 99.37 | events | `?DispatchEvent@advManager@@QAEXPAVhero@@PAVN..` | inliner (predict-inline) | 373 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (38 name-unresolvable pair(s) discounted) |
...
| 99.66 | townmgr | `??0THallWindow@@QAE@H@Z` | inliner (predict-inline) | 42 | 0 | callee expanded on one side only (A8/A9/A12): 23 under-inline, 12 over-inline (211 name-unresolvable pair(s) discounted) |
| 99.69 | dxplay | `?CreateTCPIPConnection@CDPlayLobby@@QAEPAVCD..` | unclassified | 3 | 0 | run why-reg / why-branch for the full search |
| 99.71 | rmg_support | `??0TRmgRiverPainter@@QAE@PAVTRmgMapAdapterIn..` | unclassified | 4 | 0 | run why-reg / why-branch for the full search |
...
| 99.84 | campaignbrief | `??0NewSMapHeader@@QAE@XZ` | register-homing (why-reg) | 6 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 99.85 | town | `?TownFn_005BF900@town@@QAEJJ@Z` | unclassified | 14 | 0 | run why-reg / why-branch for the full search |
| 99.86 | kb | `?DoNormalDialog@@YIXUTNormalDialogInfo@@@Z` | register-homing (why-reg) | 86 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 99.86 | combatresultswindow | `??0TCombatResultsWindow@@QAE@PBVhero@@0HHEH@Z` | inliner (predict-inline) | 160 | 0 | callee expanded on one side only (A8/A9/A12): 7 under-inline (121 name-unresolvable pair(s) discounted) |
...
| 100.00 | sacrifice_window | `?create_artifact_widgets@type_sacrifice_wind..` | inliner (predict-inline) | 4 | 0 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (70 name-unresolvable pair(s) discounted) |
