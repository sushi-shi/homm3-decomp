...
| 70.86 | spellbookwindow | `?WindowHandler@TSpellbookWindow@@UAEHPAVmess..` | inliner (predict-inline) | 509 | 250 | callee expanded on one side only (A8/A9/A12): 13 over-inline (10 name-unresolvable pair(s) discounted) |
...
| 75.41 | hero | `?WindowHandler@THeroScreenWindow@@UAEHPAVmes..` | inliner (predict-inline) | 1104 | 342 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 13 over-inline (14 name-unresolvable pair(s) discounted) |
...
| 86.36 | army | `?get_berserk_targets@army@@QBEXAAV?$vector@P..` | inliner (predict-inline) | 51 | 55 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 89.53 | ai_player | `?end_turn@type_AI_player@@QAEXXZ` | inliner (predict-inline) | 102 | 3 | callee expanded on one side only (A8/A9/A12): 2 under-inline, 2 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 90.57 | army | `?do_post_attack@army@@AAEXPAV1@HHH@Z` | inliner (predict-inline) | 235 | 131 | callee expanded on one side only (A8/A9/A12): 3 under-inline (9 name-unresolvable pair(s) discounted) |
...
| 91.32 | multiplayerwindow | `?OnSearch@TMultiPlayerWindow@@QAEEXZ` | inliner (predict-inline) | 143 | 6 | callee expanded on one side only (A8/A9/A12): 3 over-inline (28 name-unresolvable pair(s) discounted) |
...
| 91.46 | armygrp | `?get_morale_description@armyGroup@@QBE?AV?$b..` | inliner (predict-inline) | 369 | 94 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 4 over-inline (22 name-unresolvable pair(s) discounted) |
...
| 92.56 | town | `?BuildBuilding@town@@QAE?AW4type_building_id..` | inliner (predict-inline) | 85 | 0 | callee expanded on one side only (A8/A9/A12): 2 over-inline (6 name-unresolvable pair(s) discounted) |
...
| 94.01 | bottomviewsubwindow | `??0TBottomViewTown@@QAE@PAVheroWindow@@@Z` | inliner (predict-inline) | 200 | 54 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 5 over-inline (37 name-unresolvable pair(s) discounted) |
...
| 95.90 | cspriteframe | `?DrawCreatureImpl@CSpriteFrame@@QBEXHHHHPAGH..` | control-flow (why-branch) | 224 | 5 | loop-form / merged-return placement / case order (D1-D9) |
...
| 96.03 | army | `?SetSpellInfluence@army@@QAEXHHHPBVhero@@@Z` | inliner (predict-inline) | 188 | 82 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (13 name-unresolvable pair(s) discounted) |
...
| 96.23 | command | `?Main@combatManager@@UAEHAAVmessage@@@Z` | inliner (predict-inline) | 49 | 4 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (4 name-unresolvable pair(s) discounted) |
...
| 96.80 | spellbookwindow | `?get_spell_description@TSpellbookWindow@@AAE..` | inliner (predict-inline) | 23 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline (10 name-unresolvable pair(s) discounted) |
...
| 98.05 | multiplayerwindow | `?Update@TMultiPlayerWindow@@QAEXXZ` | control-flow (why-branch) | 76 | 2 | loop-form / merged-return placement / case order (D1-D9) |
...
| 98.12 | multiplayerwindow | `?OnWidgetDeselect@TMultiPlayerWindow@@UAEHHP..` | control-flow (why-branch) | 95 | 2 | loop-form / merged-return placement / case order (D1-D9) |
...
| 98.53 | command | `?ProcessNextAction@combatManager@@QAEHAAVmes..` | inliner (predict-inline) | 52 | 109 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (13 name-unresolvable pair(s) discounted) |
...
| 99.09 | recruit | `?Main@recruitUnit@@UAEHAAVmessage@@@Z` | inliner (predict-inline) | 113 | 0 | callee expanded on one side only (A8/A9/A12): 4 under-inline, 4 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 99.37 | events | `?DispatchEvent@advManager@@QAEXPAVhero@@PAVN..` | inliner (predict-inline) | 373 | 7 | callee expanded on one side only (A8/A9/A12): 1 under-inline (42 name-unresolvable pair(s) discounted) |
...
| 99.51 | philai | `?AI_enter_town@@YIXPAVhero@@PAVtown@@@Z` | register-homing (why-reg) | 31 | 0 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 99.65 | cmbtmgr | `?SetNextArmy@combatManager@@QAEXHH@Z` | inliner (predict-inline) | 39 | 0 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 5 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 99.84 | game | `?PerWeek@game@@QAEXXZ` | register-homing (why-reg) | 61 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
