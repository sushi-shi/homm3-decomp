...
| 93.35 | combatwindow | `?SendChat@CCombatChatEdit@@UAEXPBDH@Z` | inliner (predict-inline) | 8 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline (2 name-unresolvable pair(s) discounted) |
