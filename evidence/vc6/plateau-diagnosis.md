...
| 57.88 | hero | `?GiveArtifact@hero@@QAEEPBUtype_artifact@@EE..` | inliner (predict-inline) | 188 | 68 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 1 over-inline (10 name-unresolvable pair(s) discounted) |
...
| 63.94 | advmgr | `?SetEnvironmentOrigin@advManager@@QAEXUtype_..` | control-flow (why-branch) | 231 | 2 | loop-form / merged-return placement / case order (D1-D9) |
| 64.81 | cmbtmgr | `?SetupAndLoadObstacles@combatManager@@QAEXXZ` | inliner (predict-inline) | 436 | 91 | callee expanded on one side only (A8/A9/A12): 12 over-inline (4 name-unresolvable pair(s) discounted) |
| 65.18 | mapcell | `?StampObject@NewfullMap@@QAEXPAVNewmapCell@@..` | inliner (predict-inline) | 408 | 45 | callee expanded on one side only (A8/A9/A12): 1 under-inline (7 name-unresolvable pair(s) discounted) |
| 65.27 | advmgr | `?ShowRoute@advManager@@QAEXHHH@Z` | inliner (predict-inline) | 261 | 56 | callee expanded on one side only (A8/A9/A12): 3 over-inline |
| 67.19 | cmbtmgr | `?place_obstacle@combatManager@@QAEEH@Z` | inliner (predict-inline) | 149 | 46 | callee expanded on one side only (A8/A9/A12): 2 under-inline (3 name-unresolvable pair(s) discounted) |
...
| 70.99 | hero | `??0hero@@QAE@XZ` | inliner (predict-inline) | 101 | 0 | callee expanded on one side only (A8/A9/A12): 1 over-inline |
| 71.10 | hero | `?WindowHandler@THeroScreenWindow@@UAEHPAVmes..` | inliner (predict-inline) | 1438 | 379 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 11 over-inline (21 name-unresolvable pair(s) discounted) |
| 71.71 | game | `?Load@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 1182 | 131 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 7 over-inline (23 name-unresolvable pair(s) discounted) |
| 71.91 | mapcell | `?readHeroData@NewfullMap@@QAEHPAVTAbstractFi..` | inliner (predict-inline) | 625 | 72 | callee expanded on one side only (A8/A9/A12): 8 under-inline (8 name-unresolvable pair(s) discounted) |
...
| 72.92 | mapcell | `?Read@TTimedEvent@@QAEHPAVTAbstractFile@@H@Z` | inliner (predict-inline) | 71 | 25 | callee expanded on one side only (A8/A9/A12): 1 over-inline (2 name-unresolvable pair(s) discounted) |
| 73.80 | game | `?Save@game@@QAEHPAVTAbstractFile@@@Z` | inliner (predict-inline) | 618 | 126 | callee expanded on one side only (A8/A9/A12): 6 under-inline, 1 over-inline (15 name-unresolvable pair(s) discounted) |
| 74.09 | lodfile | `?Find@LODFile@@AAEXIIPBD@Z` | control-flow (why-branch) | 150 | 14 | loop-form / merged-return placement / case order (D1-D9) |
| 74.48 | armygrp | `?get_morale_description@armyGroup@@QBE?AV?$b..` | inliner (predict-inline) | 631 | 134 | callee expanded on one side only (A8/A9/A12): 7 under-inline, 2 over-inline (34 name-unresolvable pair(s) discounted) |
...
| 75.04 | hero | `?GetLuck@hero@@QAEHPBV1@EE@Z` | inliner (predict-inline) | 188 | 31 | callee expanded on one side only (A8/A9/A12): 1 over-inline (1 name-unresolvable pair(s) discounted) |
| 75.65 | advmgr | `?ProcessKeyPress@advManager@@QAEHPBVmessage@..` | control-flow (why-branch) | 390 | 79 | loop-form / merged-return placement / case order (D1-D9) |
...
| 77.17 | advmgr | `?DoAdvCommand@advManager@@QAEPAVNewmapCell@@..` | control-flow (why-branch) | 767 | 11 | loop-form / merged-return placement / case order (D1-D9) |
| 77.38 | mapcell | `?Load@NewfullMap@@QAEHPAVTAbstractFile@@HEH@Z` | inliner (predict-inline) | 351 | 15 | callee expanded on one side only (A8/A9/A12): 4 over-inline (24 name-unresolvable pair(s) discounted) |
...
| 78.04 | hero | `?update_spell_list@hero@@QAEXXZ` | control-flow (why-branch) | 103 | 8 | loop-form / merged-return placement / case order (D1-D9) |
...
| 78.41 | mapcell | `?readMapObjects@NewfullMap@@QAEHPAVTAbstract..` | inliner (predict-inline) | 349 | 36 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (36 name-unresolvable pair(s) discounted) |
| 78.80 | advmgr | `?ProcessHover@advManager@@QAEHHH@Z` | inliner (predict-inline) | 527 | 120 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (1 name-unresolvable pair(s) discounted) |
...
| 82.08 | mapcell | `?readTownData@NewfullMap@@QAEHPAVTAbstractFi..` | inliner (predict-inline) | 483 | 92 | callee expanded on one side only (A8/A9/A12): 1 over-inline (7 name-unresolvable pair(s) discounted) |
...
| 82.57 | armygrp | `?get_luck_description@armyGroup@@QBE?AV?$bas..` | inliner (predict-inline) | 121 | 40 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (13 name-unresolvable pair(s) discounted) |
...
| 82.91 | cmbtmgr | `?Open@combatManager@@UAEHH@Z` | control-flow (why-branch) | 282 | 18 | loop-form / merged-return placement / case order (D1-D9) |
...
| 83.60 | hero | `?HeroFn_004E2550@hero@@QAEEJJ@Z` | inliner (predict-inline) | 114 | 34 | callee expanded on one side only (A8/A9/A12): 1 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 85.32 | advmgr | `?TownQuickView@advManager@@QAEXHHHE@Z` | inliner (predict-inline) | 298 | 94 | callee expanded on one side only (A8/A9/A12): 4 under-inline (22 name-unresolvable pair(s) discounted) |
...
| 85.71 | hero | `?get_morale_description@hero@@QBE?AV?$basic_..` | inliner (predict-inline) | 194 | 82 | callee expanded on one side only (A8/A9/A12): 4 under-inline (31 name-unresolvable pair(s) discounted) |
| 85.74 | hero | `?get_luck_description@hero@@QBE?AV?$basic_st..` | inliner (predict-inline) | 146 | 80 | callee expanded on one side only (A8/A9/A12): 5 under-inline, 1 over-inline (33 name-unresolvable pair(s) discounted) |
...
| 86.40 | cmbtmgr | `?ShootBallisticMissile@combatManager@@QAEXHH..` | register-homing (why-reg) | 118 | 1 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
...
| 87.51 | cmbtmgr | `?SetNextArmy@combatManager@@QAEXHH@Z` | inliner (predict-inline) | 77 | 36 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (19 name-unresolvable pair(s) discounted) |
...
| 88.24 | recruit | `?Update@recruitUnit@@QAEXEJ@Z` | register-homing (why-reg) | 174 | 2 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 88.69 | mapcell | `?Save@NewfullMap@@QAEHPAVTAbstractFile@@HE@Z` | inliner (predict-inline) | 55 | 45 | callee expanded on one side only (A8/A9/A12): 3 over-inline (4 name-unresolvable pair(s) discounted) |
| 88.70 | viewarmywindow | `??0TViewArmyWindow@@QAE@PAVarmyGroup@@HPBVhe..` | inliner (predict-inline) | 144 | 32 | callee expanded on one side only (A8/A9/A12): 3 under-inline, 1 over-inline (21 name-unresolvable pair(s) discounted) |
...
| 89.64 | cmbtmgr | `?damage_message@combatManager@@QAEXPBDJJPBVa..` | register-homing (why-reg) | 51 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 89.86 | mapcell | `?loadBlackBox@NewfullMap@@QAEHPAVTAbstractFi..` | inliner (predict-inline) | 327 | 53 | callee expanded on one side only (A8/A9/A12): 1 over-inline (5 name-unresolvable pair(s) discounted) |
...
| 90.04 | advmgr | `?SetRolloverText@advManager@@QAEXPAVNewmapCe..` | inliner (predict-inline) | 864 | 400 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 5 over-inline (3 name-unresolvable pair(s) discounted) |
...
| 90.18 | advmgr | `?UpdateRadar@advManager@@QAEXUtype_point@@EE..` | control-flow (why-branch) | 546 | 15 | loop-form / merged-return placement / case order (D1-D9) |
...
| 90.20 | advmgr | `?QuickInfo@advManager@@QAEXHHH@Z` | inliner (predict-inline) | 867 | 502 | callee expanded on one side only (A8/A9/A12): 1 under-inline (11 name-unresolvable pair(s) discounted) |
| 90.75 | townmgr | `?DoBlacksmith@@YIXHH@Z` | register-homing (why-reg) | 34 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
| 90.78 | quickherowindow | `??0TQuickHeroWindow@@QAE@PAVhero@@W4TViewLev..` | inliner (predict-inline) | 239 | 75 | callee expanded on one side only (A8/A9/A12): 1 under-inline, 1 over-inline (38 name-unresolvable pair(s) discounted) |
...
| 91.18 | cmbtmgr | `?ShootAnimatedMissile@combatManager@@QAEXHHH..` | register-homing (why-reg) | 109 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 91.74 | cmbtmgr | `?ShootMissile@combatManager@@QAEXHHHHPBMPBVC..` | register-homing (why-reg) | 88 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 92.36 | hero | `?UpdateHeroScreenStatusBar@THeroScreenWindow..` | control-flow (why-branch) | 162 | 17 | loop-form / merged-return placement / case order (D1-D9) |
...
| 92.71 | hero | `?mark_spells@@YI?AV?$bitset@$0EG@@std@@H@Z` | inliner (predict-inline) | 68 | 27 | callee expanded on one side only (A8/A9/A12): 2 over-inline (11 name-unresolvable pair(s) discounted) |
...
| 93.05 | hero | `?Deallocate@hero@@QAEXEE@Z` | inliner (predict-inline) | 76 | 0 | callee expanded on one side only (A8/A9/A12): 1 under-inline (2 name-unresolvable pair(s) discounted) |
...
| 93.23 | advmgr | `?Main@advManager@@UAEHAAVmessage@@@Z` | register-homing (why-reg) | 52 | 0 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 93.70 | mapcell | `?Read@NewfullMap@@QAEHPAVTAbstractFile@@HEH@Z` | inliner (predict-inline) | 20 | 8 | callee expanded on one side only (A8/A9/A12): 2 over-inline (25 name-unresolvable pair(s) discounted) |
...
| 96.20 | cmbtmgr | `?PowEffect@combatManager@@QAEXHH@Z` | register-homing (why-reg) | 213 | 1 | name a value to steer pseudo order->EAX (B14) / decl order (B6) |
...
| 97.20 | game | `?load@playerData@@QAEHPAVTAbstractFile@@H@Z` | register-homing (why-reg) | 52 | 3 | cache-vs-reload a member/local (B13) / homing (B2/B3) |
