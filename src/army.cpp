...
RVA(0x3d540, 0x34)  // anchor-global, dc 0x43830
...
RVA(0x3d580, 0x37)  // anchor-global, dc 0x4386c
...
RVA(0x3df20, 0xDD)  // anchor-global, dc 0x44318
...
RVA(0x3e140, 0x8C0)  // anchor-global, dc 0x444a8
...
RVA(0x3ea70, 0x1DD)  // anchor-global, dc 0x44f0c
void army::add_aura()
{
    // @stub
}
...
RVA(0x3ec50, 0x1B4)  // anchor-global, dc 0x45000
...
RVA(0x3ee10, 0x1C2)  // anchor-global, dc 0x450bc
...
RVA(0x3f0b0, 0x206)  // anchor-global, dc 0x45254
...
RVA(0x3f2c0, 0x63B)  // anchor-bracket, dc 0x453c8
...
RVA(0x40310, 0x1EB)  // anchor-global, dc 0x46050
...
RVA(0x40500, 0x4B4)  // anchor-global, dc 0x461a0
...
RVA(0x409c0, 0x1F9)  // anchor-global, dc 0x464e0
...
RVA(0x40bc0, 0xA41)  // anchor-global, dc 0x46658
...
RVA(0x41610, 0x6A0)  // corroborates, dc 0x46bec
...
RVA(0x41cb0, 0x2BE)  // corroborates, dc 0x46fb0
...
RVA(0x41f70, 0x26)  // linkorder, dc 0x47270
...
RVA(0x41fa0, 0x461)  // anchor-global, dc 0x472f4
...
RVA(0x42410, 0x13B)  // anchor-global, dc 0x47690
...
RVA(0x42550, 0x35)  // linkorder, dc 0x477b8
...
RVA(0x42590, 0xC2)  // anchor-global, dc 0x477e8
...
RVA(0x428f0, 0xF6)  // anchor-global, dc 0x47c04
...
RVA(0x429f0, 0x5C)  // anchor-global, dc 0x47c74
...
RVA(0x42a50, 0x410)  // anchor-global, dc 0x47cf4
...
RVA(0x42e60, 0x169)  // anchor-global, dc 0x48168
...
RVA(0x42fd0, 0xA9)  // anchor-global, dc 0x482f0
...
RVA(0x43080, 0x50)  // anchor-global, dc 0x48454
...
RVA(0x430d0, 0x56)  // anchor-global, dc 0x484a0
...
RVA(0x43130, 0x25)  // anchor-global, dc 0x484d0
...
RVA(0x43160, 0x1BF)  // anchor-global, dc 0x48524
...
RVA(0x43840, 0x344)  // anchor-global, dc 0x4868c
...
RVA(0x43b90, 0x1FE)  // anchor-global, dc 0x48c60
...
RVA(0x43d90, 0x9C)  // anchor-global, dc 0x48fc4
...
RVA(0x43f40, 0x14F)  // anchor-global, dc 0x490f4
...
RVA(0x44090, 0x8F)  // anchor-global, dc 0x492c8
...
RVA(0x444d0, 0x3B)  // anchor-global, dc 0x49694
...
RVA(0x44510, 0x3DB)  // anchor-global, dc 0x49748
...
RVA(0x448f0, 0xB99)  // anchor-global, dc 0x499e8
...
RVA(0x45490, 0x23B)  // anchor-global, dc 0x4a348
...
RVA(0x456d0, 0x164)  // anchor-global, dc 0x4a480
void army::GoBerserk()
{
    // @stub
}
...
RVA(0x45840, 0x66)  // corroborates, dc 0x4a598
...
RVA(0x458b0, 0x9D)  // corroborates, dc 0x4a610
...
RVA(0x45950, 0x107)  // anchor-global, dc 0x4a6a4
...
RVA(0x45a60, 0x26D)  // anchor-global, dc 0x4a7ac
...
RVA(0x45cd0, 0x38)  // linkorder, dc 0x4a8b8
...
RVA(0x45d10, 0x14)  // linkorder, dc 0x4a8c8
...
RVA(0x45d30, 0x189)  // anchor-global, dc 0x4a97c
...
RVA(0x46720, 0x107)  // anchor-global, dc 0x4b454
...
RVA(0x46830, 0x103)  // anchor-global, dc 0x4b558
...
RVA(0x46940, 0x2FE)  // anchor-bracket, dc 0x4b624
...
RVA(0x46c40, 0x1E1)  // anchor-global, dc 0x4b8c4
...
RVA(0x46e30, 0x2E1)  // linkorder, dc 0x4ba88
void army::new_turn()
{
    // @stub
}
...
RVA(0x47120, 0x20A)  // linkorder, dc 0x4bc84
...
RVA(0x47330, 0x9C)  // anchor-global, dc 0x4bd80
...
RVA(0x473d0, 0x13D)  // anchor-bracket, dc 0x4be64
...
RVA(0x476c0, 0x3BA)  // anchor-global, dc 0x4beec
...
RVA(0x47eb0, 0x21)  // anchor-global, dc 0x4c374
...
RVA(0x48260, 0x582)  // anchor-global, dc 0x4c468
...
RVA(0x48ab0, 0x114)  // anchor-global, dc 0x4c82c
...
RVA(0x48bd0, 0xF6)  // anchor-bracket, dc 0x4c898
...
RVA(0x48cd0, 0x4B)  // anchor-global, dc 0x4c918
int army::GetSpeed()
{
    // @stub
}
