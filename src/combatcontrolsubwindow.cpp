    ...
    : TSubWindow(x, y, w, h, parent), m_viewLevel(viewLevel)
{
    ...
    if (viewLevel == 1) {
        ...
        const char* attackName = g_generalText->getText(381);
        ...
        const char* defenseName = g_generalText->getText(382);
        ...
        const char* damageName = g_generalText->getText(387);
        ...
        const char* speedName = g_generalText->getText(390);
        ...
        const char* moraleName = g_generalText->getText(385);
        ...
        const char* luckName = g_generalText->getText(386);
