...
DATA(0x006a6530) extern HelpText g_adventureOptionsHelp[7];
...
DC_ONLY(0x51b0, 0x54)
int AdventureOptionsWindow::convertID2HelpID(int id) const
{
    if (id < 0)
        return -1;
...
int AdventureOptionsWindow::windowHandler(message& msg)
{
