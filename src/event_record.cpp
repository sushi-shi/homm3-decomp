...
// frame 8 bytes SHORT of retail's 0x38. Frame size alone does not identify
// missing source locals. DC names four (tagRECT rect, double distance,
// unsigned short enemyMask, unsigned short* old_value). Earlier isolated
// probes spelling the bounds as a tagRECT measured 87.93 -> 87.20 (and
...
// it a slot. Those score changes do not disprove the recorded locals;
// their complete lifetime model and the frame difference remain unresolved.
