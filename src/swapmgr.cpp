...
// Retail x86 layout: 24 standalone swapmgr.cpp bodies (23 VA claims below + IsLeftHero),
// bracketed by 22 cinit/atexit initializers (excluded class, guard 0x6abaa0), and ~22 DC
// roster functions inlined/folded away in the x86 build (kept DC_ONLY below).
...
// ===========================================================================
// Located: swapmgr.cpp functions with standalone retail bodies (retail RVA order).
// Evidence per row; sizes carve-exact from config/retail-functions.tsv.
// ===========================================================================
...
// TENTATIVE: swapManager teardown - frees two std::string members at +0x3f2/+0x884,
...
VA(0x005afdf0, 0xABB)  // anchor-callee ConvertToHover + message dispatcher (calls HandleMonster/handle_*_click/SetRolloverText/OnWidgetDeselect), ret 4, dc 0x15d4ac
...
// ===========================================================================
// DC roster functions with NO standalone retail body: inlined (/Ob2 single-call-site
// or trivial) or ICF-folded in the x86 build. Kept DC_ONLY - excluded from claims.
// ===========================================================================
