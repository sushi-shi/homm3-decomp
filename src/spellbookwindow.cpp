...
void TSpellbookWindow::TSpellbookWindow(const hero* h, const armyGroup* g, TSpellbookWindow::TSpellContext context, unsigned char on_magic_plains)
{
    // @stub
}

// E:\gamedcs\spellbookwindow.cpp:474
DC_ONLY(0x14c864, 0x6E)
void TSpellbookWindow::~TSpellbookWindow()
{
    // @stub
}

// E:\gamedcs\spellbookwindow.cpp:490
DC_ONLY(0x14c8d4, 0x1A)
