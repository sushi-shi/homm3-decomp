...
-----------
  ...
  build [--fast | --require-data-exact] [TU ...] [-- <ninja args>]
        ...
        unresolved bindings, static differences, initialization and consumer gaps fatal.
  ...
  sema <xref|diff|disasm|rva|strings|data|data-match|data-initialization|data-accesses|coverage|candidates|compare> ...
