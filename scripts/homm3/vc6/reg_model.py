...
from homm3.vc6._solver import (
    _compile_tu, _fn_text, _reference_side, _resolve_symbol, _wine_dir,
)
...
def _resolve_unit(args) -> str | None:
    ...
    return _selection.reference_unit(args)
...
def _prepare(args):
    ...
    args.fn = base_sym
    ref_text, ref_label = _reference_side(args, SCRATCH)
