...
**Match score** — 3,786 / 4,763 functions exact (79.5%) across the full engine (4453 in linked units).

**Function exact MAX** — 3,826 / 4,763 functions (80.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3717 / 4384 (84.8%) | 3757 / 4384 (85.7%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 310 (0.0%) |      0 / 310 (0.0%) |    0.0% |      0.0% |
