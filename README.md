...
**Executable matched: 77.61%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,864 / 4,772 functions exact (60.0%) across the full engine (3508 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2795 / 3439 (81.3%) |  94.60% |    95.18% |
