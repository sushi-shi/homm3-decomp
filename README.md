...
**Executable matched: 89.66%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,650 / 4,765 functions exact (76.6%) across the full engine (4341 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3581 / 4272 (83.8%) |  95.45% |    95.97% |
