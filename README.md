...
**Executable matched: 43.31%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,914 / 4,749 functions exact (40.3%) across the full engine (2329 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1845 / 2260 (81.6%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,420 (0.0%) |    0.0% |      0.0% |
