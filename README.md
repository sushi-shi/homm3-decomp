...
**Executable matched: 46.08%** — fuzzy-weighted bytes over all 1,996,393 unfiltered bytes.

**Match score** — 2,168 / 4,753 functions exact (45.6%) across the full engine (2586 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2099 / 2517 (83.4%) |  96.72% |    96.72% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,167 (0.0%) |    0.0% |      0.0% |
