...
**Executable matched: 31.44%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,480 / 4,748 functions exact (31.2%) across the full engine (1849 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1411 / 1780 (79.3%) |  87.75% |    87.75% |
