...
**Executable matched: 19.40%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,113 / 4,748 functions exact (23.4%) across the full engine (1495 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1044 / 1426 (73.2%) |  63.31% |    63.31% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,253 (0.0%) |    0.0% |      0.0% |
