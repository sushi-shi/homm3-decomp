...
**Executable matched: 5.63%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 533 / 4,749 functions exact (11.2%) across the full engine (977 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 464 / 908 (51.1%) |  24.93% |    24.93% |
