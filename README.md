...
**Executable matched: 17.20%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,142 / 4,748 functions exact (24.1%) across the full engine (1517 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1073 / 1448 (74.1%) |  60.15% |    60.15% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,231 (0.0%) |    0.0% |      0.0% |
