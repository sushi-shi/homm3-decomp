...
**Executable matched: 7.84%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 609 / 4,749 functions exact (12.8%) across the full engine (982 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 540 / 913 (59.1%) |  37.33% |    37.33% |
