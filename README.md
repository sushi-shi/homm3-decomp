...
**Executable matched: 95.30%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,024 / 4,765 functions exact (84.4%) across the full engine (4710 in linked units).

**Function exact MAX** — 4,045 / 4,765 current implementations (84.9%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3955 / 4641 (85.2%) | 3976 / 4641 (85.7%) |  96.34% |    96.51% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 55 (0.0%) |       0 / 55 (0.0%) |    0.0% |      0.0% |
