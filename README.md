...
**Executable matched: 96.61%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,137 / 4,764 functions exact (86.8%) across the full engine (4760 in linked units).

**Function exact MAX** — 4,158 / 4,764 current implementations (87.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   138 | 4068 / 4691 (86.7%) | 4089 / 4691 (87.2%) |  96.58% |    96.76% |
