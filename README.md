...
**Executable matched: 75.72%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,815 / 4,770 functions exact (59.0%) across the full engine (3443 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2746 / 3374 (81.4%) |  93.87% |    94.45% |
