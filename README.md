...
**Match score** — 3,950 / 4,765 functions exact (82.9%) across the full engine (4579 in linked units).

**Function exact MAX** — 3,955 / 4,765 current implementations (83.0%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3881 / 4510 (86.1%) | 3886 / 4510 (86.2%) |  96.65% |    96.73% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 186 (0.0%) |      0 / 186 (0.0%) |    0.0% |      0.0% |
