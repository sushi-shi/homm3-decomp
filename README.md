...
**Executable matched: 42.84%** — fuzzy-weighted bytes over all 1,996,049 unfiltered bytes.

**Match score** — 1,903 / 4,748 functions exact (40.1%) across the full engine (2315 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1834 / 2246 (81.7%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,433 (0.0%) |    0.0% |      0.0% |
