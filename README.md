...
**Executable matched: 8.07%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 622 / 4,749 functions exact (13.1%) across the full engine (982 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 553 / 913 (60.6%) |  38.61% |    38.61% |
