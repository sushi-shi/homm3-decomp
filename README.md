...
**Executable matched: 75.94%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,842 / 4,772 functions exact (59.6%) across the full engine (3477 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2773 / 3408 (81.4%) |  93.47% |    94.06% |
