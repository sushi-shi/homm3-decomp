...
**Match score** — 1,105 / 4,748 functions exact (23.3%) across the full engine (1485 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1036 / 1416 (73.2%) |  63.10% |    63.10% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,263 (0.0%) |    0.0% |      0.0% |
