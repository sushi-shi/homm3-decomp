...
**Executable matched: 7.56%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 589 / 4,749 functions exact (12.4%) across the full engine (982 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 520 / 913 (57.0%) |  35.76% |    35.76% |
