...
**Executable matched: 46.70%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,118 / 4,750 functions exact (44.6%) across the full engine (2686 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2049 / 2617 (78.3%) |  83.42% |    83.42% |
