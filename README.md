...
**Executable matched: 94.55%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,991 / 4,765 functions exact (83.8%) across the full engine (4671 in linked units).

**Function exact MAX** — 4,007 / 4,765 current implementations (84.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3922 / 4602 (85.2%) | 3938 / 4602 (85.6%) |  96.31% |    96.42% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 94 (0.0%) |       0 / 94 (0.0%) |    0.0% |      0.0% |
