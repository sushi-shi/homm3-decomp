...
**Executable matched: 56.65%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,431 / 4,765 functions exact (51.0%) across the full engine (3002 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2362 / 2933 (80.5%) |  90.18% |    90.18% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,763 (0.0%) |    0.0% |      0.0% |
