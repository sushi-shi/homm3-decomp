...
**Executable matched: 95.73%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,032 / 4,764 functions exact (84.6%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,115 / 4,764 current implementations (86.4%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 3963 / 4695 (84.4%) | 4046 / 4695 (86.2%) |  95.68% |    96.30% |
