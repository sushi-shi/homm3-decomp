...
**Executable matched: 89.86%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,683 / 4,765 functions exact (77.3%) across the full engine (4361 in linked units).

**Function exact MAX** — 3,713 / 4,765 functions (77.9%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3614 / 4292 (84.2%) | 3644 / 4292 (84.9%) |  95.63% |    96.20% |
