...
**Executable matched: 95.60%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,042 / 4,764 functions exact (84.8%) across the full engine (4733 in linked units).

**Function exact MAX** — 4,063 / 4,764 current implementations (85.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   134 | 3973 / 4664 (85.2%) | 3994 / 4664 (85.6%) |  96.31% |    96.49% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 31 (0.0%) |       0 / 31 (0.0%) |    0.0% |      0.0% |
