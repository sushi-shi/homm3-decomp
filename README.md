...
**Executable matched: 62.65%** — fuzzy-weighted bytes over all 1,997,091 unfiltered bytes.

**Match score** — 2,638 / 4,766 functions exact (55.4%) across the full engine (3154 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2569 / 3085 (83.3%) |  93.38% |    93.69% |
