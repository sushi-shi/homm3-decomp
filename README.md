...
**Executable matched: 90.39%** — fuzzy-weighted bytes over all 1,998,803 unfiltered bytes.

**Match score** — 3,709 / 4,764 functions exact (77.9%) across the full engine (4370 in linked units).

**Function exact MAX** — 3,739 / 4,764 functions (78.5%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3640 / 4301 (84.6%) | 3670 / 4301 (85.3%) |  95.92% |    96.46% |
