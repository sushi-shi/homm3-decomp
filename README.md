...
**Executable matched: 15.87%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,061 / 4,748 functions exact (22.3%) across the full engine (1434 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 992 / 1365 (72.7%) |  58.09% |    58.09% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,314 (0.0%) |    0.0% |      0.0% |
