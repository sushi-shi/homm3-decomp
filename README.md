...
**Executable matched: 87.95%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,450 / 4,770 functions exact (72.3%) across the full engine (4168 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3381 / 4099 (82.5%) |  95.27% |    95.80% |
