...
**Executable matched: 8.70%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 618 / 4,749 functions exact (13.0%) across the full engine (984 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 549 / 915 (60.0%) |  42.05% |    42.05% |
