...
**Match score** — 4,035 / 4,764 functions exact (84.7%) across the full engine (4724 in linked units).

**Function exact MAX** — 4,056 / 4,764 current implementations (85.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3966 / 4655 (85.2%) | 3987 / 4655 (85.6%) |  96.31% |    96.48% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 40 (0.0%) |       0 / 40 (0.0%) |    0.0% |      0.0% |
