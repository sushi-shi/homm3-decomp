...
**Executable matched: 61.39%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,580 / 4,765 functions exact (54.1%) across the full engine (3105 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2511 / 3036 (82.7%) |  93.13% |    93.31% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,660 (0.0%) |    0.0% |      0.0% |
