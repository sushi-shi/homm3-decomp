...
**Executable matched: 72.32%** — fuzzy-weighted bytes over all 1,997,876 unfiltered bytes.

**Match score** — 2,760 / 4,769 functions exact (57.9%) across the full engine (3355 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   119 | 2691 / 3286 (81.9%) |  93.85% |    94.41% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,414 (0.0%) |    0.0% |      0.0% |
