...
**Executable matched: 90.94%** — fuzzy-weighted bytes over all 1,998,803 unfiltered bytes.

**Match score** — 3,725 / 4,764 functions exact (78.2%) across the full engine (4406 in linked units).

**Function exact MAX** — 3,756 / 4,764 functions (78.8%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3656 / 4337 (84.3%) | 3687 / 4337 (85.0%) |  95.68% |    96.30% |
