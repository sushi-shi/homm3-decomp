...
**Match score** — 4,120 / 4,764 functions exact (86.5%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,140 / 4,764 current implementations (86.9%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4051 / 4695 (86.3%) | 4071 / 4695 (86.7%) |  96.46% |    96.70% |
