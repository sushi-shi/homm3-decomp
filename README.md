...
**Executable matched: 89.77%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,682 / 4,765 functions exact (77.3%) across the full engine (4361 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   132 | 3613 / 4292 (84.2%) |  95.53% |    96.05% |
