...
**Executable matched: 93.02%** — fuzzy-weighted bytes over all 1,998,823 unfiltered bytes.

**Match score** — 3,955 / 4,765 functions exact (83.0%) across the full engine (4587 in linked units).

**Function exact MAX** — 3,962 / 4,765 current implementations (83.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3886 / 4518 (86.0%) | 3893 / 4518 (86.2%) |  96.65% |    96.73% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 178 (0.0%) |      0 / 178 (0.0%) |    0.0% |      0.0% |
