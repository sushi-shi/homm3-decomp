...
**Executable matched: 4.42%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 361 / 4,749 functions exact (7.6%) across the full engine (706 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 292 / 637 (45.8%) |  33.44% |    33.44% |
