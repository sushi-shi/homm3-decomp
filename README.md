...
**Executable matched: 44.79%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,032 / 4,750 functions exact (42.8%) across the full engine (2822 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1963 / 2753 (71.3%) |  71.80% |    71.80% |
