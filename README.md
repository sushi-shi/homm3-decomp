...
**Executable matched: 65.54%** — fuzzy-weighted bytes over all 1,997,132 unfiltered bytes.

**Match score** — 2,697 / 4,767 functions exact (56.6%) across the full engine (3262 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2628 / 3193 (82.3%) |  93.27% |    93.90% |
