...
**Executable matched: 95.89%** — fuzzy-weighted bytes over all 1,998,985 unfiltered bytes.

**Match score** — 4,082 / 4,765 functions exact (85.7%) across the full engine (4765 in linked units).

**Function exact MAX** — 4,158 / 4,765 current implementations (87.3%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4013 / 4696 (85.5%) | 4089 / 4696 (87.1%) |  95.84% |    96.49% |
