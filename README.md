...
**Executable matched: 1.35%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 96 / 4,760 functions exact (2.0%) across the full engine (117 in linked units).

| Module        | Units |  Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | ------: | --------: |
| `zlib-1.1.3`  |    14 | 69 / 69 (100.0%) | 100.00% |   100.00% |
| `game`        |     5 |  27 / 48 (56.2%) |  22.85% |    22.85% |
| `(unmatched)` |     — | 0 / 4,643 (0.0%) |    0.0% |      0.0% |
