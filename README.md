...
**Executable matched: 61.31%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,576 / 4,765 functions exact (54.1%) across the full engine (3100 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2507 / 3031 (82.7%) |  93.12% |    93.31% |
