...
**Executable matched: 18.94%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,103 / 4,748 functions exact (23.2%) across the full engine (1477 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1034 / 1408 (73.4%) |  62.83% |    62.83% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,271 (0.0%) |    0.0% |      0.0% |
