...
**Executable matched: 49.16%** — fuzzy-weighted bytes over all 1,996,539 unfiltered bytes.

**Match score** — 2,267 / 4,755 functions exact (47.7%) across the full engine (2701 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2198 / 2632 (83.5%) |  96.71% |    96.71% |
