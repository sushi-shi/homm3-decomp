...
**Executable matched: 95.69%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,039 / 4,764 functions exact (84.8%) across the full engine (4732 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3970 / 4663 (85.1%) | 3991 / 4663 (85.6%) |  96.27% |    96.44% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 32 (0.0%) |       0 / 32 (0.0%) |    0.0% |      0.0% |
