...
**Executable matched: 30.82%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,463 / 4,748 functions exact (30.8%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1394 / 1741 (80.1%) |  88.96% |    88.96% |
