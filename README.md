...
**Executable matched: 89.00%** — fuzzy-weighted bytes over all 1,998,094 unfiltered bytes.

**Match score** — 3,533 / 4,760 functions exact (74.2%) across the full engine (4248 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3464 / 4179 (82.9%) |  95.40% |    95.92% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 512 (0.0%) |    0.0% |      0.0% |
