...
**Executable matched: 3.99%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 313 / 4,749 functions exact (6.6%) across the full engine (701 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 244 / 632 (38.6%) |  28.93% |    28.93% |
