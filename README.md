...
**Match score** — 3,767 / 4,763 functions exact (79.1%) across the full engine (4427 in linked units).

**Function exact MAX** — 3,799 / 4,763 functions (79.8%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3698 / 4358 (84.9%) | 3730 / 4358 (85.6%) |  96.08% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 336 (0.0%) |      0 / 336 (0.0%) |    0.0% |      0.0% |
