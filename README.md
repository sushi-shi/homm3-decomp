...
**Executable matched: 94.47%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,992 / 4,765 functions exact (83.8%) across the full engine (4667 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3923 / 4598 (85.3%) | 3937 / 4598 (85.6%) |  96.30% |    96.41% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 98 (0.0%) |       0 / 98 (0.0%) |    0.0% |      0.0% |
