...
**Executable matched: 75.52%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,818 / 4,770 functions exact (59.1%) across the full engine (3443 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2749 / 3374 (81.5%) |  93.61% |    94.19% |
