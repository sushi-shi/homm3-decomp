...
**Executable matched: 95.92%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,048 / 4,764 functions exact (85.0%) across the full engine (4745 in linked units).

**Function exact MAX** — 4,069 / 4,764 current implementations (85.4%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   135 | 3979 / 4676 (85.1%) | 4000 / 4676 (85.5%) |  96.26% |    96.44% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 19 (0.0%) |       0 / 19 (0.0%) |    0.0% |      0.0% |
