...
**Executable matched: 16.31%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,111 / 4,748 functions exact (23.4%) across the full engine (1478 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1042 / 1409 (74.0%) |  59.87% |    59.87% |
