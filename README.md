...
**Executable matched: 49.74%** — fuzzy-weighted bytes over all 1,996,542 unfiltered bytes.

**Match score** — 2,281 / 4,753 functions exact (48.0%) across the full engine (2720 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2212 / 2651 (83.4%) |  96.68% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,033 (0.0%) |    0.0% |      0.0% |
