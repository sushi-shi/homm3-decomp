...
**Executable matched: 95.57%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,038 / 4,764 functions exact (84.8%) across the full engine (4726 in linked units).

**Function exact MAX** — 4,059 / 4,764 current implementations (85.2%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3969 / 4657 (85.2%) | 3990 / 4657 (85.7%) |  96.31% |    96.49% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 38 (0.0%) |       0 / 38 (0.0%) |    0.0% |      0.0% |
