...
**Executable matched: 36.77%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,557 / 4,748 functions exact (32.8%) across the full engine (1944 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1488 / 1875 (79.4%) |  96.04% |    96.04% |
