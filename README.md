...
**Executable matched: 44.46%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 1,969 / 4,750 functions exact (41.5%) across the full engine (2407 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1900 / 2338 (81.3%) |  94.71% |    94.71% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,343 (0.0%) |    0.0% |      0.0% |
