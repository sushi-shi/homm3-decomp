...
**Executable matched: 94.63%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,997 / 4,765 functions exact (83.9%) across the full engine (4685 in linked units).

**Function exact MAX** — 4,015 / 4,765 current implementations (84.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3928 / 4616 (85.1%) | 3946 / 4616 (85.5%) |  96.11% |    96.28% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 80 (0.0%) |       0 / 80 (0.0%) |    0.0% |      0.0% |
