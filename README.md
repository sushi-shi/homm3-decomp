...
**Match score** — 4,053 / 4,764 functions exact (85.1%) across the full engine (4749 in linked units).

**Function exact MAX** — 4,075 / 4,764 current implementations (85.5%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   135 | 3984 / 4680 (85.1%) | 4006 / 4680 (85.6%) |  96.27% |    96.44% |
