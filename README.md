...
**Executable matched: 96.52%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,122 / 4,764 functions exact (86.5%) across the full engine (4764 in linked units).
...
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4053 / 4695 (86.3%) | 4076 / 4695 (86.8%) |  96.48% |    96.72% |
