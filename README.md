...
**Executable matched: 94.60%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,995 / 4,765 functions exact (83.8%) across the full engine (4678 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3926 / 4609 (85.2%) | 3941 / 4609 (85.5%) |  96.20% |    96.35% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 87 (0.0%) |       0 / 87 (0.0%) |    0.0% |      0.0% |
