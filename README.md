...
**Executable matched: 96.51%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,121 / 4,764 functions exact (86.5%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,144 / 4,764 current implementations (87.0%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4052 / 4695 (86.3%) | 4075 / 4695 (86.8%) |  96.47% |    96.72% |
