...
**Executable matched: 49.40%** — fuzzy-weighted bytes over all 1,996,542 unfiltered bytes.

**Match score** — 2,278 / 4,753 functions exact (47.9%) across the full engine (2713 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2209 / 2644 (83.5%) |  96.72% |    96.72% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,040 (0.0%) |    0.0% |      0.0% |
