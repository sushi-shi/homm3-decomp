...
**Match score** — 3,807 / 4,763 functions exact (79.9%) across the full engine (4474 in linked units).

**Function exact MAX** — 3,847 / 4,763 functions (80.8%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3738 / 4405 (84.9%) | 3778 / 4405 (85.8%) |  96.08% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 289 (0.0%) |      0 / 289 (0.0%) |    0.0% |      0.0% |
