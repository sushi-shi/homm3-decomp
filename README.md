...
**Executable matched: 83.32%** — fuzzy-weighted bytes over all 1,998,047 unfiltered bytes.

**Match score** — 3,157 / 4,772 functions exact (66.2%) across the full engine (3851 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   126 | 3088 / 3782 (81.6%) |  95.04% |    95.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 921 (0.0%) |    0.0% |      0.0% |
