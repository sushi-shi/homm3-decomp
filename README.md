...
**Executable matched: 8.81%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 624 / 4,749 functions exact (13.1%) across the full engine (984 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 555 / 915 (60.7%) |  42.67% |    42.67% |
