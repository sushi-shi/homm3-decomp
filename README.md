...
**Executable matched: 63.83%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,645 / 4,768 functions exact (55.5%) across the full engine (3159 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2576 / 3090 (83.4%) |  95.12% |    95.65% |
