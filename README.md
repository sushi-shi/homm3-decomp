...
**Match score** — 3,771 / 4,763 functions exact (79.2%) across the full engine (4439 in linked units).

**Function exact MAX** — 3,811 / 4,763 functions (80.0%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3702 / 4370 (84.7%) | 3742 / 4370 (85.6%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 324 (0.0%) |      0 / 324 (0.0%) |    0.0% |      0.0% |
