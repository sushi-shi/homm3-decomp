...
**Match score** — 3,327 / 4,772 functions exact (69.7%) across the full engine (4053 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   127 | 3258 / 3984 (81.8%) |  95.02% |    95.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 719 (0.0%) |    0.0% |      0.0% |
