...
**Executable matched: 51.28%** — fuzzy-weighted bytes over all 1,996,563 unfiltered bytes.

**Match score** — 2,312 / 4,752 functions exact (48.7%) across the full engine (2915 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2243 / 2846 (78.8%) |  82.56% |    82.56% |
