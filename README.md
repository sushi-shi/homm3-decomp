...
**Executable matched: 15.61%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,045 / 4,748 functions exact (22.0%) across the full engine (1414 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 976 / 1345 (72.6%) |  57.67% |    57.67% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,334 (0.0%) |    0.0% |      0.0% |
