...
**Executable matched: 14.39%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,016 / 4,748 functions exact (21.4%) across the full engine (1382 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 947 / 1313 (72.1%) |  53.60% |    53.60% |
