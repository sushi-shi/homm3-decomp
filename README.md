...
**Match score** — 4,101 / 4,766 functions exact (86.0%) across the full engine (4766 in linked units).

**Function exact MAX** — 4,166 / 4,766 current implementations (87.4%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4032 / 4697 (85.8%) | 4097 / 4697 (87.2%) |  95.86% |    96.37% |
