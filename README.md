...
**Executable matched: 15.89%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,062 / 4,748 functions exact (22.4%) across the full engine (1421 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 993 / 1352 (73.4%) |  58.62% |    58.62% |
