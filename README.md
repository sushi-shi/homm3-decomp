...
**Executable matched: 28.80%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,451 / 4,748 functions exact (30.6%) across the full engine (1809 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1382 / 1740 (79.4%) |  82.91% |    82.91% |
