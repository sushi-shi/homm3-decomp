...
**Match score** — 4,129 / 4,764 functions exact (86.7%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,150 / 4,764 current implementations (87.1%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4060 / 4695 (86.5%) | 4081 / 4695 (86.9%) |  96.52% |    96.75% |
