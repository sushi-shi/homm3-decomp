...
**Executable matched: 58.06%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,478 / 4,765 functions exact (52.0%) across the full engine (3055 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2409 / 2986 (80.7%) |  89.88% |    89.88% |
