...
**Executable matched: 88.70%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,499 / 4,768 functions exact (73.4%) across the full engine (4227 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3430 / 4158 (82.5%) |  95.26% |    95.79% |
