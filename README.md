...
**Executable matched: 95.27%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,024 / 4,765 functions exact (84.4%) across the full engine (4709 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3955 / 4640 (85.2%) | 3976 / 4640 (85.7%) |  96.33% |    96.50% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 56 (0.0%) |       0 / 56 (0.0%) |    0.0% |      0.0% |
