...
**Executable matched: 74.42%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,790 / 4,770 functions exact (58.5%) across the full engine (3429 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   121 | 2721 / 3360 (81.0%) |  92.81% |    93.34% |
