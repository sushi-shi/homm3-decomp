...
**Match score** — 2,768 / 4,769 functions exact (58.0%) across the full engine (3366 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   119 | 2699 / 3297 (81.9%) |  93.78% |    94.34% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,403 (0.0%) |    0.0% |      0.0% |
