...
**Executable matched: 35.71%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,525 / 4,748 functions exact (32.1%) across the full engine (1886 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1456 / 1817 (80.1%) |  95.49% |    95.49% |
