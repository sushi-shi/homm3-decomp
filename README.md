...
**Executable matched: 92.65%** — fuzzy-weighted bytes over all 1,998,823 unfiltered bytes.

**Match score** — 3,905 / 4,765 functions exact (82.0%) across the full engine (4532 in linked units).

**Function exact MAX** — 3,910 / 4,765 current implementations (82.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3836 / 4463 (86.0%) | 3841 / 4463 (86.1%) |  96.65% |    96.73% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 233 (0.0%) |      0 / 233 (0.0%) |    0.0% |      0.0% |
