...
**Executable matched: 15.83%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,060 / 4,748 functions exact (22.3%) across the full engine (1418 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 991 / 1349 (73.5%) |  58.53% |    58.53% |
