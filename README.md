...
**Executable matched: 48.78%** — fuzzy-weighted bytes over all 1,996,518 unfiltered bytes.

**Match score** — 2,235 / 4,755 functions exact (47.0%) across the full engine (2668 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2166 / 2599 (83.3%) |  96.76% |    96.76% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,087 (0.0%) |    0.0% |      0.0% |
