...
**Executable matched: 44.86%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,046 / 4,750 functions exact (43.1%) across the full engine (2822 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1977 / 2753 (71.8%) |  71.92% |    71.92% |
