...
**Executable matched: 92.99%** — fuzzy-weighted bytes over all 1,998,823 unfiltered bytes.

**Match score** — 3,952 / 4,765 functions exact (82.9%) across the full engine (4581 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3883 / 4512 (86.1%) | 3888 / 4512 (86.2%) |  96.65% |    96.73% |
