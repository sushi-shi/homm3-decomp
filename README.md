...
**Function exact MAX** — 4,272 / 4,766 current implementations (89.6%) have reached 100%.

**CUR diagnostics** — 4,210 / 4,766 functions exact (88.3%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3545 / 3989 (88.9%) | 3592 / 3989 (90.0%) |    97.21% |    97.54% |
