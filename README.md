...
**Match score** — 3,762 / 4,763 functions exact (79.0%) across the full engine (4431 in linked units).

**Function exact MAX** — 3,803 / 4,763 functions (79.8%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3693 / 4362 (84.7%) | 3734 / 4362 (85.6%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 332 (0.0%) |      0 / 332 (0.0%) |    0.0% |      0.0% |
