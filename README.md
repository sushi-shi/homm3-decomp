...
**Executable matched: 79.75%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,966 / 4,772 functions exact (62.2%) across the full engine (3639 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   125 | 2897 / 3570 (81.1%) |  94.51% |    95.10% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,133 (0.0%) |    0.0% |      0.0% |
