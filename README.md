...
**Executable matched: 95.66%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,039 / 4,764 functions exact (84.8%) across the full engine (4730 in linked units).

**Function exact MAX** — 4,060 / 4,764 current implementations (85.2%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3970 / 4661 (85.2%) | 3991 / 4661 (85.6%) |  96.29% |    96.47% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 34 (0.0%) |       0 / 34 (0.0%) |    0.0% |      0.0% |
