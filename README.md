...
**Executable matched: 69.75%** — fuzzy-weighted bytes over all 1,997,547 unfiltered bytes.

**Match score** — 2,738 / 4,766 functions exact (57.4%) across the full engine (3311 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   119 | 2669 / 3242 (82.3%) |  94.16% |    94.77% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,455 (0.0%) |    0.0% |      0.0% |
