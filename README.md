...
**Match score** — 4,104 / 4,765 functions exact (86.1%) across the full engine (4765 in linked units).

**Function exact MAX** — 4,170 / 4,765 current implementations (87.5%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4035 / 4696 (85.9%) | 4101 / 4696 (87.3%) |  95.92% |    96.50% |
