...
**Executable matched: 36.54%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,548 / 4,748 functions exact (32.6%) across the full engine (1936 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1479 / 1867 (79.2%) |  95.52% |    95.52% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,812 (0.0%) |    0.0% |      0.0% |
