...
**Match score** — 4,044 / 4,764 functions exact (84.9%) across the full engine (4742 in linked units).

**Function exact MAX** — 4,065 / 4,764 current implementations (85.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   134 | 3975 / 4673 (85.1%) | 3996 / 4673 (85.5%) |  96.26% |    96.43% |
