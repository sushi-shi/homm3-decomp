...
**Executable matched: 95.15%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 3,950 / 4,764 functions exact (82.9%) across the full engine (4751 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   135 | 3881 / 4682 (82.9%) | 3973 / 4682 (84.9%) |  95.36% |    96.02% |
