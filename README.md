...
**Executable matched: 89.07%** — fuzzy-weighted bytes over all 1,998,094 unfiltered bytes.

**Match score** — 3,534 / 4,760 functions exact (74.2%) across the full engine (4248 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3465 / 4179 (82.9%) |  95.47% |    95.99% |
