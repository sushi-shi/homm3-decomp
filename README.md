...
**Executable matched: 45.60%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,142 / 4,750 functions exact (45.1%) across the full engine (2560 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2073 / 2491 (83.2%) |  96.69% |    96.69% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,190 (0.0%) |    0.0% |      0.0% |
