...
**Match score** — 1,041 / 4,748 functions exact (21.9%) across the full engine (1397 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 972 / 1328 (73.2%) |  58.03% |    58.03% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,351 (0.0%) |    0.0% |      0.0% |
