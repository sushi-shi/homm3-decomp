...
**Executable matched: 19.14%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,103 / 4,748 functions exact (23.2%) across the full engine (1481 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1034 / 1412 (73.2%) |  62.98% |    62.98% |
