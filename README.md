...
**Function exact MAX** — 4,274 / 4,769 current implementations (89.6%) have reached 100%.

_CUR / MAX / HIST: 4,203 / 4,274 / 4,386 exact; 96.59% / 97.08% / 98.24% weighted fuzzy. CUR is this build; HIST retains peaks from earlier source implementations. Unchanged-source CUR dips do not lower MAX._

| Module       | Units | Functions exact MAX | Fuzzy MAX |
| :----------- | ----: | ------------------: | --------: |
| `game`       |   123 | 3595 / 3991 (90.1%) |    97.29% |
