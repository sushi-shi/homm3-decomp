...
**Match score** — 3,771 / 4,763 functions exact (79.2%) across the full engine (4441 in linked units).

**Function exact MAX** — 3,813 / 4,763 functions (80.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3702 / 4372 (84.7%) | 3744 / 4372 (85.6%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 322 (0.0%) |      0 / 322 (0.0%) |    0.0% |      0.0% |
