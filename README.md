...
**Executable matched: 63.53%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,638 / 4,768 functions exact (55.3%) across the full engine (3158 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2569 / 3089 (83.2%) |  94.68% |    95.02% |
