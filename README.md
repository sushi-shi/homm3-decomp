...
**Match score** — 4,026 / 4,765 functions exact (84.5%) across the full engine (4710 in linked units).

**Function exact MAX** — 4,046 / 4,765 current implementations (84.9%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3957 / 4641 (85.3%) | 3977 / 4641 (85.7%) |  96.34% |    96.51% |
