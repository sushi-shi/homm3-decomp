...
**Executable matched: 49.96%** — fuzzy-weighted bytes over all 1,996,563 unfiltered bytes.

**Match score** — 2,281 / 4,752 functions exact (48.0%) across the full engine (2722 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2212 / 2653 (83.4%) |  96.64% |    96.64% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,030 (0.0%) |    0.0% |      0.0% |
