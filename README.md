...
**Executable matched: 10.03%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 656 / 4,749 functions exact (13.8%) across the full engine (986 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 587 / 917 (64.0%) |  49.44% |    49.44% |
