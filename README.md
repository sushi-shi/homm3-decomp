...
**Executable matched: 19.33%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,109 / 4,748 functions exact (23.4%) across the full engine (1490 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1040 / 1421 (73.2%) |  63.22% |    63.22% |
