...
**Executable matched: 88.15%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,456 / 4,768 functions exact (72.5%) across the full engine (4186 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3387 / 4117 (82.3%) |  95.24% |    95.77% |
