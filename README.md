...
**Executable MAX: 96.83%** — weighted by function size across 1,999,142 bytes of code included in matching.

**Function exact MAX** — 4,237 / 4,768 current implementations (88.9%) have reached 100%.

**CUR diagnostics** — 4,175 / 4,768 functions exact (87.6%) in this build (4768 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3509 / 3991 (87.9%) | 3559 / 3991 (89.2%) |    96.73% |    96.99% |
