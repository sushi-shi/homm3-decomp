...
**Executable matched: 94.53%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,992 / 4,765 functions exact (83.8%) across the full engine (4670 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3923 / 4601 (85.3%) | 3938 / 4601 (85.6%) |  96.32% |    96.43% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 95 (0.0%) |       0 / 95 (0.0%) |    0.0% |      0.0% |
