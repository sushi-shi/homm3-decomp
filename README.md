...
**Executable matched: 17.06%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,099 / 4,748 functions exact (23.1%) across the full engine (1469 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1030 / 1400 (73.6%) |  60.41% |    60.41% |
