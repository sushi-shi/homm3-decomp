...
**Executable matched: 88.88%** — fuzzy-weighted bytes over all 1,998,094 unfiltered bytes.

**Match score** — 3,511 / 4,760 functions exact (73.8%) across the full engine (4227 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3442 / 4158 (82.8%) |  95.41% |    95.94% |
