...
**Function exact MAX** — 4,262 / 4,766 current implementations (89.4%) have reached 100%.

**CUR diagnostics** — 4,199 / 4,766 functions exact (88.1%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3534 / 3989 (88.6%) | 3582 / 3989 (89.8%) |    97.12% |    97.46% |
