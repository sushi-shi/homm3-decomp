...
**Executable matched: 28.15%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,448 / 4,748 functions exact (30.5%) across the full engine (1809 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1379 / 1740 (79.3%) |  80.94% |    80.94% |
