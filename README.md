...
**Match score** — 3,962 / 4,765 functions exact (83.1%) across the full engine (4590 in linked units).

**Function exact MAX** — 3,969 / 4,765 current implementations (83.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3893 / 4521 (86.1%) | 3900 / 4521 (86.3%) |  96.66% |    96.73% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 175 (0.0%) |      0 / 175 (0.0%) |    0.0% |      0.0% |
