...
**Function exact MAX** — 4,252 / 4,766 current implementations (89.2%) have reached 100%.

**CUR diagnostics** — 4,188 / 4,766 functions exact (87.9%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3523 / 3989 (88.3%) | 3572 / 3989 (89.5%) |    96.84% |    97.18% |
