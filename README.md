...
**Executable matched: 33.93%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,511 / 4,748 functions exact (31.8%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1442 / 1813 (79.5%) |  90.84% |    90.84% |
