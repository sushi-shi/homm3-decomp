...
**Executable matched: 8.77%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 622 / 4,749 functions exact (13.1%) across the full engine (984 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 553 / 915 (60.4%) |  42.44% |    42.44% |
