...
**Executable matched: 43.15%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,911 / 4,749 functions exact (40.2%) across the full engine (2326 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1842 / 2257 (81.6%) |  96.57% |    96.57% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,423 (0.0%) |    0.0% |      0.0% |
