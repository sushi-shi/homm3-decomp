...
**Executable matched: 7.83%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 608 / 4,749 functions exact (12.8%) across the full engine (982 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 539 / 913 (59.0%) |  37.26% |    37.26% |
