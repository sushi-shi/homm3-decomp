...
**Executable matched: 76.77%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,855 / 4,772 functions exact (59.8%) across the full engine (3489 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2786 / 3420 (81.5%) |  94.19% |    94.77% |
