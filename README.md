...
**Executable matched: 77.24%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,863 / 4,772 functions exact (60.0%) across the full engine (3508 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2794 / 3439 (81.2%) |  94.14% |    94.71% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,264 (0.0%) |    0.0% |      0.0% |
