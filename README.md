...
**Executable matched: 46.43%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,121 / 4,750 functions exact (44.7%) across the full engine (2746 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2052 / 2677 (76.7%) |  79.71% |    79.71% |
