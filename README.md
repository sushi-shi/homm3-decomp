...
**Match score** — 3,784 / 4,763 functions exact (79.4%) across the full engine (4451 in linked units).

**Function exact MAX** — 3,824 / 4,763 functions (80.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3715 / 4382 (84.8%) | 3755 / 4382 (85.7%) |  96.07% |    96.68% |
