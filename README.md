...
**Executable matched: 36.56%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,550 / 4,748 functions exact (32.6%) across the full engine (1940 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1481 / 1871 (79.2%) |  95.52% |    95.52% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,808 (0.0%) |    0.0% |      0.0% |
