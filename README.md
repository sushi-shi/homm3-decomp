...
**Executable matched: 16.00%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,074 / 4,748 functions exact (22.6%) across the full engine (1448 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1005 / 1379 (72.9%) |  58.26% |    58.26% |
