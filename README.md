...
**Executable matched: 8.62%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 615 / 4,749 functions exact (13.0%) across the full engine (984 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 546 / 915 (59.7%) |  41.61% |    41.61% |
