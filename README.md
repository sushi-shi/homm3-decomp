...
**Executable matched: 44.55%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 1,990 / 4,750 functions exact (41.9%) across the full engine (2654 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1921 / 2585 (74.3%) |  75.45% |    75.45% |
