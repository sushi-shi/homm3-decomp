...
**Match score** — 3,780 / 4,763 functions exact (79.4%) across the full engine (4448 in linked units).

**Function exact MAX** — 3,820 / 4,763 functions (80.2%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3711 / 4379 (84.7%) | 3751 / 4379 (85.7%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 315 (0.0%) |      0 / 315 (0.0%) |    0.0% |      0.0% |
