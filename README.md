...
**Executable matched: 58.94%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,481 / 4,765 functions exact (52.1%) across the full engine (3058 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2412 / 2989 (80.7%) |  91.14% |    91.14% |
