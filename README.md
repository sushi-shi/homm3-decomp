...
**Executable matched: 69.99%** — fuzzy-weighted bytes over all 1,997,547 unfiltered bytes.

**Match score** — 2,739 / 4,766 functions exact (57.5%) across the full engine (3313 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   119 | 2670 / 3244 (82.3%) |  94.17% |    94.77% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,453 (0.0%) |    0.0% |      0.0% |
