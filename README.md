...
**Executable matched: 64.02%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,643 / 4,768 functions exact (55.4%) across the full engine (3159 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2574 / 3090 (83.3%) |  95.42% |    95.95% |
