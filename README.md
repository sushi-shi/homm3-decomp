...
**Executable matched: 5.84%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 551 / 4,749 functions exact (11.6%) across the full engine (978 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 482 / 909 (53.0%) |  26.09% |    26.09% |
