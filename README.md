...
**Executable matched: 77.83%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,889 / 4,772 functions exact (60.5%) across the full engine (3536 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2820 / 3467 (81.3%) |  94.62% |    95.19% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,236 (0.0%) |    0.0% |      0.0% |
