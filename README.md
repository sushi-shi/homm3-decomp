...
**Executable MAX: 97.37%** — weighted by function size across 1,999,142 bytes of code included in matching.

**Function exact MAX** — 4,306 / 4,768 current implementations (90.3%) have reached 100%.

_CUR / MAX / HIST: 4,268 / 4,306 / 4,377 exact; 97.09% / 97.37% / 98.21% weighted fuzzy. CUR is this build; HIST retains peaks from earlier source implementations. Unchanged-source CUR dips do not lower MAX._

| Module       | Units | Functions exact MAX | Fuzzy MAX |
| :----------- | ----: | ------------------: | --------: |
| `game`       |   123 | 3627 / 3991 (90.9%) |    97.60% |
| `rmg`        |     3 |   301 / 368 (81.8%) |    94.37% |
| `network`    |     4 |   269 / 280 (96.1%) |    98.30% |
| `zlib-1.1.3` |    14 |    69 / 69 (100.0%) |   100.00% |
| `codec`      |     4 |     35 / 43 (81.4%) |    94.70% |
...
**Lightly optimized Classic Mac PowerPC reference (last full checkpoint):** 402 / 1044 scored functions exact; 59.37% of 244,988 compared bytes match. Scored functions are source claims whose full-TU body links; this is coverage, not the whole Mac game.
