...
**Executable matched: 91.71%** — fuzzy-weighted bytes over all 1,998,803 unfiltered bytes.

**Match score** — 3,761 / 4,763 functions exact (79.0%) across the full engine (4430 in linked units).

**Function exact MAX** — 3,802 / 4,763 functions (79.8%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3692 / 4361 (84.7%) | 3733 / 4361 (85.6%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 333 (0.0%) |      0 / 333 (0.0%) |    0.0% |      0.0% |
