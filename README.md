...
**Executable matched: 15.63%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,051 / 4,748 functions exact (22.1%) across the full engine (1408 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 982 / 1339 (73.3%) |  58.21% |    58.21% |
