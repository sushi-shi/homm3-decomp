...
**Match score** — 3,785 / 4,763 functions exact (79.5%) across the full engine (4452 in linked units).

**Function exact MAX** — 3,825 / 4,763 functions (80.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3716 / 4383 (84.8%) | 3756 / 4383 (85.7%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 311 (0.0%) |      0 / 311 (0.0%) |    0.0% |      0.0% |
