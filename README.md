...
**Executable matched: 89.58%** — fuzzy-weighted bytes over all 1,998,615 unfiltered bytes.

**Match score** — 3,625 / 4,764 functions exact (76.1%) across the full engine (4331 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3556 / 4262 (83.4%) |  95.41% |    95.93% |
