...
**Executable matched: 47.41%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,152 / 4,750 functions exact (45.3%) across the full engine (2754 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2083 / 2685 (77.6%) |  80.76% |    80.76% |
