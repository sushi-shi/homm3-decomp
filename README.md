...
**Executable matched: 78.60%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,924 / 4,772 functions exact (61.3%) across the full engine (3587 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   124 | 2855 / 3518 (81.2%) |  94.60% |    95.19% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,185 (0.0%) |    0.0% |      0.0% |
