...
**Executable matched: 95.97%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,050 / 4,764 functions exact (85.0%) across the full engine (4747 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   135 | 3981 / 4678 (85.1%) | 4002 / 4678 (85.5%) |  96.27% |    96.44% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 17 (0.0%) |       0 / 17 (0.0%) |    0.0% |      0.0% |
