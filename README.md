...
**Executable matched: 1.56%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 112 / 4,760 functions exact (2.4%) across the full engine (146 in linked units).

| Module        | Units |  Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ---------------: | ------: | --------: |
| `game`        |     6 |  43 / 77 (55.8%) |  43.35% |    43.35% |
| `zlib-1.1.3`  |    14 | 69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — | 0 / 4,614 (0.0%) |    0.0% |      0.0% |
