...
**Executable matched: 25.75%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,426 / 4,748 functions exact (30.0%) across the full engine (1809 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1357 / 1740 (78.0%) |  73.60% |    73.60% |
