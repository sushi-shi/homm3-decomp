...
**Executable matched: 46.02%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,112 / 4,750 functions exact (44.5%) across the full engine (2686 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2043 / 2617 (78.1%) |  82.16% |    82.16% |
