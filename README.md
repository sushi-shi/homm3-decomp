...
**Executable matched: 89.72%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,647 / 4,765 functions exact (76.5%) across the full engine (4341 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3578 / 4272 (83.8%) |  95.51% |    96.01% |
