...
**Executable matched: 43.91%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,953 / 4,749 functions exact (41.1%) across the full engine (2368 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1884 / 2299 (81.9%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,381 (0.0%) |    0.0% |      0.0% |
