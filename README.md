...
**Executable matched: 92.67%** — fuzzy-weighted bytes over all 1,998,823 unfiltered bytes.

**Match score** — 3,913 / 4,765 functions exact (82.1%) across the full engine (4537 in linked units).

**Function exact MAX** — 3,919 / 4,765 current implementations (82.2%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3844 / 4468 (86.0%) | 3850 / 4468 (86.2%) |  96.65% |    96.73% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 228 (0.0%) |      0 / 228 (0.0%) |    0.0% |      0.0% |
