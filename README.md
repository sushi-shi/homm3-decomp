...
**Executable matched: 16.49%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,127 / 4,748 functions exact (23.7%) across the full engine (1494 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1058 / 1425 (74.2%) |  60.15% |    60.15% |
