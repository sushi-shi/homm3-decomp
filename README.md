...
**Executable matched: 42.79%** — fuzzy-weighted bytes over all 1,996,049 unfiltered bytes.

**Match score** — 1,900 / 4,748 functions exact (40.0%) across the full engine (2312 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1831 / 2243 (81.6%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,436 (0.0%) |    0.0% |      0.0% |
