...
**Executable matched: 4.32%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 349 / 4,749 functions exact (7.3%) across the full engine (706 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 280 / 637 (44.0%) |  32.33% |    32.33% |
