...
**Executable matched: 15.42%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,017 / 4,748 functions exact (21.4%) across the full engine (1383 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 948 / 1314 (72.1%) |  57.79% |    57.79% |
