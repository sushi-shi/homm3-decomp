...
**Executable matched: 62.60%** — fuzzy-weighted bytes over all 1,997,091 unfiltered bytes.

**Match score** — 2,639 / 4,766 functions exact (55.4%) across the full engine (3154 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2570 / 3085 (83.3%) |  93.30% |    93.62% |
