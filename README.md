...
**Executable matched: 95.45%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,031 / 4,765 functions exact (84.6%) across the full engine (4717 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3962 / 4648 (85.2%) | 3982 / 4648 (85.7%) |  96.32% |    96.50% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 48 (0.0%) |       0 / 48 (0.0%) |    0.0% |      0.0% |
