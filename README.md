...
**Executable matched: 28.70%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,451 / 4,748 functions exact (30.6%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1382 / 1741 (79.4%) |  82.43% |    82.43% |
