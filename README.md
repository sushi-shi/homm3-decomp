...
**Executable matched: 43.20%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,912 / 4,749 functions exact (40.3%) across the full engine (2327 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1843 / 2258 (81.6%) |  96.58% |    96.58% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,422 (0.0%) |    0.0% |      0.0% |
