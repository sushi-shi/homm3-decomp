...
**Executable matched: 96.54%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,125 / 4,764 functions exact (86.6%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,146 / 4,764 current implementations (87.0%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4056 / 4695 (86.4%) | 4077 / 4695 (86.8%) |  96.50% |    96.74% |
