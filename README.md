...
**Executable matched: 95.72%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,032 / 4,764 functions exact (84.6%) across the full engine (4763 in linked units).

**Function exact MAX** — 4,114 / 4,764 current implementations (86.4%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   138 | 3963 / 4694 (84.4%) | 4045 / 4694 (86.2%) |  95.67% |    96.29% |
