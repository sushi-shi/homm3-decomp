...
**Match score** — 1,045 / 4,748 functions exact (22.0%) across the full engine (1412 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 976 / 1343 (72.7%) |  57.60% |    57.60% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,336 (0.0%) |    0.0% |      0.0% |
