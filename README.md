...
**Executable matched: 88.20%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,474 / 4,768 functions exact (72.9%) across the full engine (4204 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3405 / 4135 (82.3%) |  95.24% |    95.78% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 564 (0.0%) |    0.0% |      0.0% |
