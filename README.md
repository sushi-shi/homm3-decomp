...
**Executable matched: 32.45%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,502 / 4,748 functions exact (31.6%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1433 / 1813 (79.0%) |  86.71% |    86.71% |
