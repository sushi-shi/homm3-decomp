...
**Executable matched: 89.64%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,657 / 4,765 functions exact (76.7%) across the full engine (4358 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   132 | 3588 / 4289 (83.7%) |  95.40% |    95.92% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 407 (0.0%) |    0.0% |      0.0% |
