...
**Match score** — 3,322 / 4,772 functions exact (69.6%) across the full engine (4045 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   126 | 3253 / 3976 (81.8%) |  95.11% |    95.64% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 727 (0.0%) |    0.0% |      0.0% |
