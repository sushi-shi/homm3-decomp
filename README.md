...
**Match score** — 1,969 / 4,750 functions exact (41.5%) across the full engine (2395 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1900 / 2326 (81.7%) |  95.30% |    95.30% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,355 (0.0%) |    0.0% |      0.0% |
