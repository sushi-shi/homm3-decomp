...
**Match score** — 4,030 / 4,765 functions exact (84.6%) across the full engine (4713 in linked units).

**Function exact MAX** — 4,050 / 4,765 current implementations (85.0%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3961 / 4644 (85.3%) | 3981 / 4644 (85.7%) |  96.34% |    96.51% |
