...
**Executable matched: 45.44%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,122 / 4,750 functions exact (44.7%) across the full engine (2540 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2053 / 2471 (83.1%) |  96.68% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,210 (0.0%) |    0.0% |      0.0% |
