...
**Executable matched: 61.29%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,570 / 4,765 functions exact (53.9%) across the full engine (3100 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2501 / 3031 (82.5%) |  93.09% |    93.30% |
