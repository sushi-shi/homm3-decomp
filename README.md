...
**Executable matched: 36.95%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,585 / 4,748 functions exact (33.4%) across the full engine (1944 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1516 / 1875 (80.9%) |  96.53% |    96.53% |
