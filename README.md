...
**Match score** — 1,056 / 4,748 functions exact (22.2%) across the full engine (1413 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 987 / 1344 (73.4%) |  58.35% |    58.35% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,335 (0.0%) |    0.0% |      0.0% |
