...
**Executable matched: 82.61%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 3,136 / 4,772 functions exact (65.7%) across the full engine (3824 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   125 | 3067 / 3755 (81.7%) |  95.04% |    95.61% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 948 (0.0%) |    0.0% |      0.0% |
