...
**Executable matched: 89.37%** — fuzzy-weighted bytes over all 1,998,615 unfiltered bytes.

**Match score** — 3,576 / 4,764 functions exact (75.1%) across the full engine (4295 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3507 / 4226 (83.0%) |  95.46% |    95.97% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 469 (0.0%) |    0.0% |      0.0% |
