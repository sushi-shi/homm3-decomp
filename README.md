...
**Executable matched: 57.02%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,450 / 4,765 functions exact (51.4%) across the full engine (3002 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2381 / 2933 (81.2%) |  90.78% |    90.78% |
