...
**Executable matched: 61.34%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,578 / 4,765 functions exact (54.1%) across the full engine (3103 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2509 / 3034 (82.7%) |  93.13% |    93.31% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,662 (0.0%) |    0.0% |      0.0% |
