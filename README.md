...
**Executable matched: 15.44%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,025 / 4,748 functions exact (21.6%) across the full engine (1383 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 956 / 1314 (72.8%) |  57.86% |    57.86% |
