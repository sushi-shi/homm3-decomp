...
**Executable matched: 34.26%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,513 / 4,748 functions exact (31.9%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1444 / 1813 (79.6%) |  91.76% |    91.76% |
