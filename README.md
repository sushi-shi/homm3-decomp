...
**Executable matched: 75.77%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,832 / 4,772 functions exact (59.3%) across the full engine (3458 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2763 / 3389 (81.5%) |  93.84% |    94.43% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,314 (0.0%) |    0.0% |      0.0% |
