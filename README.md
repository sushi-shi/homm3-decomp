...
**Executable matched: 16.28%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,103 / 4,748 functions exact (23.2%) across the full engine (1470 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1034 / 1401 (73.8%) |  59.82% |    59.82% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,278 (0.0%) |    0.0% |      0.0% |
