...
**Executable matched: 43.93%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 1,956 / 4,750 functions exact (41.2%) across the full engine (2371 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1887 / 2302 (82.0%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,379 (0.0%) |    0.0% |      0.0% |
