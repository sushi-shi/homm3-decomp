...
**Executable matched: 16.43%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,104 / 4,748 functions exact (23.3%) across the full engine (1479 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1035 / 1410 (73.4%) |  58.96% |    58.96% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,269 (0.0%) |    0.0% |      0.0% |
