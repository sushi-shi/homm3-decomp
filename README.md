...
**Executable matched: 96.14%** — fuzzy-weighted bytes over all 1,998,996 unfiltered bytes.

**Match score** — 4,123 / 4,766 functions exact (86.5%) across the full engine (4766 in linked units).
...
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4054 / 4697 (86.3%) | 4114 / 4697 (87.6%) |  96.09% |    96.57% |
