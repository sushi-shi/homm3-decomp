...
**Executable matched: 49.86%** — fuzzy-weighted bytes over all 1,996,563 unfiltered bytes.

**Match score** — 2,281 / 4,752 functions exact (48.0%) across the full engine (2721 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2212 / 2652 (83.4%) |  96.67% |    96.67% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,031 (0.0%) |    0.0% |      0.0% |
