...
**Executable matched: 87.64%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,416 / 4,770 functions exact (71.6%) across the full engine (4148 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   127 | 3347 / 4079 (82.1%) |  95.22% |    95.75% |
