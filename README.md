...
**Executable matched: 46.05%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,103 / 4,750 functions exact (44.3%) across the full engine (2686 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2034 / 2617 (77.7%) |  82.22% |    82.22% |
