...
**Executable matched: 54.80%** — fuzzy-weighted bytes over all 1,996,623 unfiltered bytes.

**Match score** — 2,368 / 4,755 functions exact (49.8%) across the full engine (2921 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2299 / 2852 (80.6%) |  88.31% |    88.31% |
