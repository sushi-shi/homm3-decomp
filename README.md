...
**Executable matched: 48.59%** — fuzzy-weighted bytes over all 1,996,539 unfiltered bytes.

**Match score** — 2,177 / 4,755 functions exact (45.8%) across the full engine (2772 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2108 / 2703 (78.0%) |  81.94% |    81.94% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,983 (0.0%) |    0.0% |      0.0% |
