...
**Executable matched: 89.76%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,680 / 4,765 functions exact (77.2%) across the full engine (4361 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   132 | 3611 / 4292 (84.1%) |  95.53% |    96.04% |
