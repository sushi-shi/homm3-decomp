...
**Executable matched: 61.45%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,582 / 4,765 functions exact (54.2%) across the full engine (3107 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2513 / 3038 (82.7%) |  93.14% |    93.32% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,658 (0.0%) |    0.0% |      0.0% |
