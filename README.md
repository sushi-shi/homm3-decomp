...
**Executable matched: 49.03%** — fuzzy-weighted bytes over all 1,996,539 unfiltered bytes.

**Match score** — 2,252 / 4,755 functions exact (47.4%) across the full engine (2686 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2183 / 2617 (83.4%) |  96.70% |    96.70% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,069 (0.0%) |    0.0% |      0.0% |
