...
**Executable matched: 31.05%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,469 / 4,748 functions exact (30.9%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1400 / 1741 (80.4%) |  89.65% |    89.65% |
