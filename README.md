...
**Executable matched: 94.34%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,990 / 4,765 functions exact (83.7%) across the full engine (4661 in linked units).

**Function exact MAX** — 4,004 / 4,765 current implementations (84.0%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3921 / 4592 (85.4%) | 3935 / 4592 (85.7%) |  96.26% |    96.38% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 104 (0.0%) |      0 / 104 (0.0%) |    0.0% |      0.0% |
