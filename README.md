...
**Executable matched: 62.13%** — fuzzy-weighted bytes over all 1,997,091 unfiltered bytes.

**Match score** — 2,619 / 4,766 functions exact (55.0%) across the full engine (3148 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2550 / 3079 (82.8%) |  93.39% |    93.60% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,618 (0.0%) |    0.0% |      0.0% |
