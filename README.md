...
**Executable matched: 7.53%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 588 / 4,749 functions exact (12.4%) across the full engine (982 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 519 / 913 (56.8%) |  35.59% |    35.59% |
