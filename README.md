...
**Match score** — 3,774 / 4,763 functions exact (79.2%) across the full engine (4444 in linked units).

**Function exact MAX** — 3,816 / 4,763 functions (80.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3705 / 4375 (84.7%) | 3747 / 4375 (85.6%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 319 (0.0%) |      0 / 319 (0.0%) |    0.0% |      0.0% |
