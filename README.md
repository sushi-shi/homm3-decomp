...
**Executable matched: 95.53%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,032 / 4,765 functions exact (84.6%) across the full engine (4721 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3963 / 4652 (85.2%) | 3984 / 4652 (85.6%) |  96.31% |    96.48% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 44 (0.0%) |       0 / 44 (0.0%) |    0.0% |      0.0% |
