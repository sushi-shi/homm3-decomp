...
**Executable matched: 79.02%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,923 / 4,772 functions exact (61.3%) across the full engine (3590 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2854 / 3521 (81.1%) |  94.70% |    95.27% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,182 (0.0%) |    0.0% |      0.0% |
