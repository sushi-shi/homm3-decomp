...
**Match score** — 2,148 / 4,750 functions exact (45.2%) across the full engine (2566 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2079 / 2497 (83.3%) |  96.70% |    96.70% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,184 (0.0%) |    0.0% |      0.0% |
