...
**Executable matched: 60.23%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,509 / 4,765 functions exact (52.7%) across the full engine (3079 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2440 / 3010 (81.1%) |  92.21% |    92.21% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,686 (0.0%) |    0.0% |      0.0% |
