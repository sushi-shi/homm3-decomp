...
**Match score** — 1,969 / 4,750 functions exact (41.5%) across the full engine (2396 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1900 / 2327 (81.7%) |  95.29% |    95.29% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,354 (0.0%) |    0.0% |      0.0% |
