...
**Match score** — 3,958 / 4,765 functions exact (83.1%) across the full engine (4590 in linked units).

**Function exact MAX** — 3,965 / 4,765 current implementations (83.2%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3889 / 4521 (86.0%) | 3896 / 4521 (86.2%) |  96.65% |    96.73% |
