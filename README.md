...
**Match score** — 3,999 / 4,765 functions exact (83.9%) across the full engine (4685 in linked units).

**Function exact MAX** — 4,017 / 4,765 current implementations (84.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3930 / 4616 (85.1%) | 3948 / 4616 (85.5%) |  96.12% |    96.29% |
