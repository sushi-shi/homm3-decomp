...
**Executable matched: 88.24%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,474 / 4,768 functions exact (72.9%) across the full engine (4205 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3405 / 4136 (82.3%) |  95.24% |    95.78% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 563 (0.0%) |    0.0% |      0.0% |
