...
**Executable matched: 77.77%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,889 / 4,772 functions exact (60.5%) across the full engine (3535 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2820 / 3466 (81.4%) |  94.61% |    95.19% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,237 (0.0%) |    0.0% |      0.0% |
