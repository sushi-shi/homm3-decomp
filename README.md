...
**Executable matched: 74.57%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,791 / 4,770 functions exact (58.5%) across the full engine (3429 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   121 | 2722 / 3360 (81.0%) |  93.00% |    93.53% |
