...
**Executable matched: 62.31%** — fuzzy-weighted bytes over all 1,997,091 unfiltered bytes.

**Match score** — 2,620 / 4,766 functions exact (55.0%) across the full engine (3150 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2551 / 3081 (82.8%) |  93.55% |    93.76% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,616 (0.0%) |    0.0% |      0.0% |
