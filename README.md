...
**Executable matched: 19.26%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,107 / 4,748 functions exact (23.3%) across the full engine (1487 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1038 / 1418 (73.2%) |  63.13% |    63.13% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,261 (0.0%) |    0.0% |      0.0% |
