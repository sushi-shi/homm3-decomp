...
**Executable matched: 46.02%** — fuzzy-weighted bytes over all 1,996,393 unfiltered bytes.

**Match score** — 2,166 / 4,753 functions exact (45.6%) across the full engine (2584 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2097 / 2515 (83.4%) |  96.72% |    96.72% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,169 (0.0%) |    0.0% |      0.0% |
