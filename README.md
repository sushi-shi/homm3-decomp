...
**Executable matched: 44.90%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,048 / 4,750 functions exact (43.1%) across the full engine (2822 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1979 / 2753 (71.9%) |  71.98% |    71.98% |
