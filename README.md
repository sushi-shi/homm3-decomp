...
**Executable matched: 16.30%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,098 / 4,748 functions exact (23.1%) across the full engine (1473 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1029 / 1404 (73.3%) |  58.74% |    58.74% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,275 (0.0%) |    0.0% |      0.0% |
