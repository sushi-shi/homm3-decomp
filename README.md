...
**Executable matched: 84.37%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 3,186 / 4,772 functions exact (66.8%) across the full engine (3899 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   126 | 3117 / 3830 (81.4%) |  94.85% |    95.43% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 873 (0.0%) |    0.0% |      0.0% |
