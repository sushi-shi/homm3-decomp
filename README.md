...
**Executable matched: 95.51%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,031 / 4,765 functions exact (84.6%) across the full engine (4719 in linked units).

**Function exact MAX** — 4,051 / 4,765 current implementations (85.0%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3962 / 4650 (85.2%) | 3982 / 4650 (85.6%) |  96.31% |    96.48% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 46 (0.0%) |       0 / 46 (0.0%) |    0.0% |      0.0% |
