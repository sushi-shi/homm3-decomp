...
**Executable matched: 15.28%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,026 / 4,748 functions exact (21.6%) across the full engine (1392 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 957 / 1323 (72.3%) |  57.11% |    57.11% |
