...
**Executable matched: 95.20%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,012 / 4,765 functions exact (84.2%) across the full engine (4704 in linked units).

**Function exact MAX** — 4,031 / 4,765 current implementations (84.6%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3943 / 4635 (85.1%) | 3962 / 4635 (85.5%) |  96.33% |    96.50% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 61 (0.0%) |       0 / 61 (0.0%) |    0.0% |      0.0% |
