...
**Function exact MAX** — 4,234 / 4,766 current implementations (88.8%) have reached 100%.

**CUR diagnostics** — 4,166 / 4,766 functions exact (87.4%) in this build (4764 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module        | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :------------ | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`        |   138 | 4165 / 4695 (88.7%) | 4097 / 4695 (87.3%) |    96.86% |    96.44% |
