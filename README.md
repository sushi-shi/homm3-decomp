...
**Executable matched: 95.78%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,045 / 4,764 functions exact (84.9%) across the full engine (4740 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   135 | 3976 / 4671 (85.1%) | 3997 / 4671 (85.6%) |  96.27% |    96.45% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 24 (0.0%) |       0 / 24 (0.0%) |    0.0% |      0.0% |
