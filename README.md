...
**Match score** — 3,587 / 4,764 functions exact (75.3%) across the full engine (4301 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3518 / 4232 (83.1%) |  95.43% |    95.95% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 463 (0.0%) |    0.0% |      0.0% |
