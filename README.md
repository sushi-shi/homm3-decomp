...
**Executable matched: 45.85%** — fuzzy-weighted bytes over all 1,996,393 unfiltered bytes.

**Match score** — 2,163 / 4,753 functions exact (45.5%) across the full engine (2581 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2094 / 2512 (83.4%) |  96.70% |    96.70% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,172 (0.0%) |    0.0% |      0.0% |
