...
**Executable MAX: 96.48%** — MAX-weighted bytes over all 1,998,996 unfiltered bytes.

**Function exact MAX** — 4,193 / 4,766 current implementations (88.0%) have reached 100%.

**CUR diagnostics** — 4,123 / 4,766 functions exact (86.5%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   138 | 4124 / 4697 (87.8%) | 4054 / 4697 (86.3%) |    96.44% |    95.98% |
