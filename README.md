...
**Match score** — 4,034 / 4,765 functions exact (84.7%) across the full engine (4722 in linked units).

**Function exact MAX** — 4,055 / 4,765 current implementations (85.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   133 | 3965 / 4653 (85.2%) | 3986 / 4653 (85.7%) |  96.31% |    96.48% |
