...
**Executable matched: 44.47%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 1,977 / 4,750 functions exact (41.6%) across the full engine (2456 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1908 / 2387 (79.9%) |  95.22% |    95.22% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,294 (0.0%) |    0.0% |      0.0% |
