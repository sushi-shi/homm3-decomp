...
**Executable matched: 74.61%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,797 / 4,770 functions exact (58.6%) across the full engine (3442 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2728 / 3373 (80.9%) |  92.53% |    93.16% |
