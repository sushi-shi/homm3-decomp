...
**Executable matched: 30.49%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,460 / 4,748 functions exact (30.7%) across the full engine (1811 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1391 / 1742 (79.9%) |  87.95% |    87.95% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,937 (0.0%) |    0.0% |      0.0% |
