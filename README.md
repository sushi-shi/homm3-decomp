...
**Executable matched: 42.77%** — fuzzy-weighted bytes over all 1,996,049 unfiltered bytes.

**Match score** — 1,898 / 4,748 functions exact (40.0%) across the full engine (2310 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1829 / 2241 (81.6%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,438 (0.0%) |    0.0% |      0.0% |
