...
**Match score** — 1,070 / 4,748 functions exact (22.5%) across the full engine (1431 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1001 / 1362 (73.5%) |  59.00% |    59.00% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,317 (0.0%) |    0.0% |      0.0% |
