...
**Match score** — 1,135 / 4,748 functions exact (23.9%) across the full engine (1507 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1066 / 1438 (74.1%) |  60.81% |    60.81% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,241 (0.0%) |    0.0% |      0.0% |
