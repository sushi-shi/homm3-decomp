...
**Executable matched: 35.67%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,522 / 4,748 functions exact (32.1%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1453 / 1813 (80.1%) |  95.66% |    95.66% |
