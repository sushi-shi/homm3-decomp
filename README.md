...
**Executable matched: 17.50%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,099 / 4,748 functions exact (23.1%) across the full engine (1470 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1030 / 1401 (73.5%) |  61.01% |    61.01% |
