...
**Executable matched: 63.63%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,641 / 4,768 functions exact (55.4%) across the full engine (3159 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2572 / 3090 (83.2%) |  94.82% |    95.17% |
