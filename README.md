...
**Executable matched: 30.94%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,465 / 4,748 functions exact (30.9%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1396 / 1741 (80.2%) |  89.32% |    89.32% |
