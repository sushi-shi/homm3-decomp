...
**Executable matched: 16.19%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,087 / 4,748 functions exact (22.9%) across the full engine (1462 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1018 / 1393 (73.1%) |  58.57% |    58.57% |
