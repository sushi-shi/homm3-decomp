...
**Executable matched: 96.04%** — fuzzy-weighted bytes over all 1,998,985 unfiltered bytes.

**Match score** — 4,103 / 4,765 functions exact (86.1%) across the full engine (4765 in linked units).
...
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4034 / 4696 (85.9%) | 4095 / 4696 (87.2%) |  95.99% |    96.54% |
