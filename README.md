...
**Executable matched: 61.21%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,549 / 4,765 functions exact (53.5%) across the full engine (3100 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2480 / 3031 (81.8%) |  92.97% |    93.16% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,665 (0.0%) |    0.0% |      0.0% |
