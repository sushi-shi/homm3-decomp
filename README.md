...
**Executable matched: 88.87%** — fuzzy-weighted bytes over all 1,998,094 unfiltered bytes.

**Match score** — 3,512 / 4,760 functions exact (73.8%) across the full engine (4227 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3443 / 4158 (82.8%) |  95.40% |    95.93% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 533 (0.0%) |    0.0% |      0.0% |
