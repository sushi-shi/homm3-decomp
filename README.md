...
**Executable matched: 47.53%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,156 / 4,750 functions exact (45.4%) across the full engine (2754 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2087 / 2685 (77.7%) |  80.97% |    80.97% |
