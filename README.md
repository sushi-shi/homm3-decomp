...
**Executable matched: 74.55%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,792 / 4,770 functions exact (58.5%) across the full engine (3430 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   121 | 2723 / 3361 (81.0%) |  92.92% |    93.55% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,340 (0.0%) |    0.0% |      0.0% |
