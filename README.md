...
**Executable matched: 96.11%** — fuzzy-weighted bytes over all 1,998,996 unfiltered bytes.

**Match score** — 4,143 / 4,766 functions exact (86.9%) across the full engine (4766 in linked units).

**Function exact MAX** — 4,207 / 4,766 current implementations (88.3%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4074 / 4697 (86.7%) | 4138 / 4697 (88.1%) |  96.06% |    96.59% |
