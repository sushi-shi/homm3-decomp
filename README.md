...
**Executable matched: 43.43%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,927 / 4,749 functions exact (40.6%) across the full engine (2338 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1858 / 2269 (81.9%) |  96.64% |    96.64% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,411 (0.0%) |    0.0% |      0.0% |
