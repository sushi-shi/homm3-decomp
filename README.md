...
**Executable matched: 96.59%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,136 / 4,764 functions exact (86.8%) across the full engine (4760 in linked units).

**Function exact MAX** — 4,157 / 4,764 current implementations (87.3%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   138 | 4067 / 4691 (86.7%) | 4088 / 4691 (87.1%) |  96.56% |    96.74% |
