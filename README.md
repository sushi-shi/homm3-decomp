...
**Executable matched: 71.17%** — fuzzy-weighted bytes over all 1,997,876 unfiltered bytes.

**Match score** — 2,753 / 4,769 functions exact (57.7%) across the full engine (3343 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   119 | 2684 / 3274 (82.0%) |  93.67% |    94.23% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,426 (0.0%) |    0.0% |      0.0% |
