...
**Executable matched: 94.22%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,990 / 4,765 functions exact (83.7%) across the full engine (4660 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3921 / 4591 (85.4%) | 3935 / 4591 (85.7%) |  96.20% |    96.32% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 105 (0.0%) |      0 / 105 (0.0%) |    0.0% |      0.0% |
