...
**Executable matched: 25.16%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,428 / 4,748 functions exact (30.1%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1359 / 1741 (78.1%) |  71.78% |    71.78% |
