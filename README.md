...
**Executable matched: 15.62%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,050 / 4,748 functions exact (22.1%) across the full engine (1407 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 981 / 1338 (73.3%) |  58.18% |    58.18% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,341 (0.0%) |    0.0% |      0.0% |
