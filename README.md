...
**Executable matched: 78.03%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,894 / 4,772 functions exact (60.6%) across the full engine (3543 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2825 / 3474 (81.3%) |  94.63% |    95.20% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,229 (0.0%) |    0.0% |      0.0% |
