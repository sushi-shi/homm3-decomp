...
**Executable matched: 30.21%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,460 / 4,748 functions exact (30.7%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1391 / 1741 (79.9%) |  87.15% |    87.15% |
