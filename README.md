...
**Executable matched: 31.10%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,466 / 4,748 functions exact (30.9%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1397 / 1741 (80.2%) |  89.82% |    89.82% |
