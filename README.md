...
**Executable matched: 64.20%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,636 / 4,768 functions exact (55.3%) across the full engine (3163 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2567 / 3094 (83.0%) |  95.45% |    96.08% |
