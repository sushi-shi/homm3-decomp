...
**Match score** — 2,147 / 4,750 functions exact (45.2%) across the full engine (2565 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2078 / 2496 (83.3%) |  96.70% |    96.70% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,185 (0.0%) |    0.0% |      0.0% |
