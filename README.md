...
**Executable matched: 87.96%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,452 / 4,770 functions exact (72.4%) across the full engine (4168 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   128 | 3383 / 4099 (82.5%) |  95.29% |    95.81% |
