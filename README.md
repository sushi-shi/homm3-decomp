...
**Executable matched: 34.24%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,512 / 4,748 functions exact (31.8%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1443 / 1813 (79.6%) |  91.69% |    91.69% |
