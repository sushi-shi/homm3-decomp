...
**Match score** — 3,767 / 4,764 functions exact (79.1%) across the full engine (4427 in linked units).

**Function exact MAX** — 3,799 / 4,764 functions (79.7%) have reached 100%.
...
| `(unmatched)` |     — |      0 / 337 (0.0%) |      0 / 337 (0.0%) |    0.0% |      0.0% |
