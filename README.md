...
**Executable MAX: 97.03%** — weighted by function size across 1,998,996 bytes of code included in matching.

**Function exact MAX** — 4,249 / 4,766 current implementations (89.2%) have reached 100%.

**CUR diagnostics** — 4,186 / 4,766 functions exact (87.8%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3521 / 3989 (88.3%) | 3569 / 3989 (89.5%) |    96.82% |    97.16% |
