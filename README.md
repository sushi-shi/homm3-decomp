...
**Executable matched: 95.86%** — fuzzy-weighted bytes over all 1,998,996 unfiltered bytes.

**Match score** — 4,098 / 4,766 functions exact (86.0%) across the full engine (4766 in linked units).

**Function exact MAX** — 4,165 / 4,766 current implementations (87.4%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4029 / 4697 (85.8%) | 4096 / 4697 (87.2%) |  95.81% |    96.36% |
