...
**Executable matched: 91.79%** — fuzzy-weighted bytes over all 1,998,803 unfiltered bytes.

**Match score** — 3,815 / 4,763 functions exact (80.1%) across the full engine (4485 in linked units).

**Function exact MAX** — 3,857 / 4,763 functions (81.0%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3746 / 4416 (84.8%) | 3788 / 4416 (85.8%) |  96.08% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 278 (0.0%) |      0 / 278 (0.0%) |    0.0% |      0.0% |
