...
**Executable matched: 64.15%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,644 / 4,768 functions exact (55.5%) across the full engine (3161 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2575 / 3092 (83.3%) |  95.54% |    96.05% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,607 (0.0%) |    0.0% |      0.0% |
