...
**Executable matched: 36.69%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,554 / 4,748 functions exact (32.7%) across the full engine (1943 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1485 / 1874 (79.2%) |  95.87% |    95.87% |
