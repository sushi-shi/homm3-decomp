...
**Match score** — 3,759 / 4,763 functions exact (78.9%) across the full engine (4428 in linked units).

**Function exact MAX** — 3,800 / 4,763 functions (79.8%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3690 / 4359 (84.7%) | 3731 / 4359 (85.6%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 335 (0.0%) |      0 / 335 (0.0%) |    0.0% |      0.0% |
