...
**Executable matched: 15.55%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,023 / 4,748 functions exact (21.5%) across the full engine (1383 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 954 / 1314 (72.6%) |  58.30% |    58.30% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,365 (0.0%) |    0.0% |      0.0% |
