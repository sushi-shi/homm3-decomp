...
**Executable matched: 3.97%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 312 / 4,749 functions exact (6.6%) across the full engine (695 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 243 / 626 (38.8%) |  28.81% |    28.81% |
