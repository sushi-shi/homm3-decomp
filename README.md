...
**Match score** — 1,043 / 4,748 functions exact (22.0%) across the full engine (1410 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 974 / 1341 (72.6%) |  57.43% |    57.43% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,338 (0.0%) |    0.0% |      0.0% |
