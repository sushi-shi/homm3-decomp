...
**Executable matched: 72.73%** — fuzzy-weighted bytes over all 1,997,876 unfiltered bytes.

**Match score** — 2,773 / 4,769 functions exact (58.1%) across the full engine (3374 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   119 | 2704 / 3305 (81.8%) |  93.75% |    94.32% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,395 (0.0%) |    0.0% |      0.0% |
