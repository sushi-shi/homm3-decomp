...
**Executable MAX: 96.51%** — MAX-weighted bytes over all 1,998,996 unfiltered bytes.

**Function exact MAX** — 4,191 / 4,766 current implementations (87.9%) have reached 100%.

**CUR diagnostics** — 4,114 / 4,766 functions exact (86.3%) in this build (4764 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module        | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :------------ | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`        |   138 | 4122 / 4695 (87.8%) | 4045 / 4695 (86.2%) |    96.47% |    95.91% |
