...
**Executable matched: 4.38%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 375 / 4,749 functions exact (7.9%) across the full engine (724 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 306 / 655 (46.7%) |  32.85% |    32.85% |
