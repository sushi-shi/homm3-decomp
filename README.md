...
**Match score** — 2,585 / 4,765 functions exact (54.2%) across the full engine (3108 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2516 / 3039 (82.8%) |  93.14% |    93.32% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,657 (0.0%) |    0.0% |      0.0% |
