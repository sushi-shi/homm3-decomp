...
**Match score** — 3,575 / 4,764 functions exact (75.0%) across the full engine (4294 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3506 / 4225 (83.0%) |  95.46% |    95.97% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 470 (0.0%) |    0.0% |      0.0% |
