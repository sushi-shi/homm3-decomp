...
**Executable matched: 29.42%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,454 / 4,748 functions exact (30.6%) across the full engine (1809 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1385 / 1740 (79.6%) |  84.76% |    84.76% |
