...
**Executable matched: 63.58%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,640 / 4,768 functions exact (55.4%) across the full engine (3158 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2571 / 3089 (83.2%) |  94.76% |    95.10% |
