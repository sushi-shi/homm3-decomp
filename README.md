...
**Executable matched: 88.97%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,541 / 4,768 functions exact (74.3%) across the full engine (4269 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   129 | 3472 / 4200 (82.7%) |  95.27% |    95.79% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 499 (0.0%) |    0.0% |      0.0% |
