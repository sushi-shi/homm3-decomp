...
**Executable matched: 96.53%** — fuzzy-weighted bytes over all 1,998,942 unfiltered bytes.

**Match score** — 4,124 / 4,764 functions exact (86.6%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,145 / 4,764 current implementations (87.0%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4055 / 4695 (86.4%) | 4076 / 4695 (86.8%) |  96.49% |    96.73% |
