...
**Function exact MAX** — 4,241 / 4,766 current implementations (89.0%) have reached 100%.

**CUR diagnostics** — 4,178 / 4,766 functions exact (87.7%) in this build (4764 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module        | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :------------ | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`        |   127 | 3829 / 4267 (89.7%) | 3778 / 4267 (88.5%) |    97.07% |    96.72% |
