...
**Executable matched: 44.52%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 1,986 / 4,750 functions exact (41.8%) across the full engine (2654 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1917 / 2585 (74.2%) |  75.40% |    75.40% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,096 (0.0%) |    0.0% |      0.0% |
