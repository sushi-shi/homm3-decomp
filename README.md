...
**Function exact MAX** — 4,255 / 4,766 current implementations (89.3%) have reached 100%.

**CUR diagnostics** — 4,191 / 4,766 functions exact (87.9%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3526 / 3989 (88.4%) | 3575 / 3989 (89.6%) |    96.87% |    97.21% |
