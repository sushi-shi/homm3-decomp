...
**Executable matched: 5.10%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 464 / 4,749 functions exact (9.8%) across the full engine (977 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 395 / 908 (43.5%) |  21.90% |    21.90% |
