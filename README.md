...
**Executable matched: 64.21%** — fuzzy-weighted bytes over all 1,997,146 unfiltered bytes.

**Match score** — 2,645 / 4,768 functions exact (55.5%) across the full engine (3162 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2576 / 3093 (83.3%) |  95.54% |    96.06% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,606 (0.0%) |    0.0% |      0.0% |
