...
**Executable MAX: 97.23%** — weighted by function size across 1,998,996 bytes of code included in matching.

**Function exact MAX** — 4,259 / 4,766 current implementations (89.4%) have reached 100%.

**CUR diagnostics** — 4,195 / 4,766 functions exact (88.0%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3530 / 3989 (88.5%) | 3579 / 3989 (89.7%) |    97.05% |    97.39% |
