...
**Executable matched: 43.56%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,929 / 4,749 functions exact (40.6%) across the full engine (2341 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1860 / 2272 (81.9%) |  96.65% |    96.65% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,408 (0.0%) |    0.0% |      0.0% |
