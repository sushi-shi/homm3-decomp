...
**Executable matched: 32.88%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,507 / 4,748 functions exact (31.7%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1438 / 1813 (79.3%) |  87.93% |    87.93% |
