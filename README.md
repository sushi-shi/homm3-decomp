...
**Executable matched: 6.14%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 557 / 4,749 functions exact (11.7%) across the full engine (978 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 488 / 909 (53.7%) |  27.79% |    27.79% |
| `zlib-1.1.3`  |    14 |  69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |  0 / 3,771 (0.0%) |    0.0% |      0.0% |
