...
**Executable matched: 19.62%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,122 / 4,748 functions exact (23.6%) across the full engine (1507 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1053 / 1438 (73.2%) |  63.61% |    63.61% |
