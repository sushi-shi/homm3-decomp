...
**Match score** — 1,026 / 4,748 functions exact (21.6%) across the full engine (1387 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 957 / 1318 (72.6%) |  59.41% |    59.41% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,361 (0.0%) |    0.0% |      0.0% |
