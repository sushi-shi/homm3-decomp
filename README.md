...
**Executable matched: 24.87%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,423 / 4,748 functions exact (30.0%) across the full engine (1809 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1354 / 1740 (77.8%) |  70.95% |    70.95% |
