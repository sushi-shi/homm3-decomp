...
**Executable matched: 30.90%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,467 / 4,748 functions exact (30.9%) across the full engine (1810 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1398 / 1741 (80.3%) |  89.21% |    89.21% |
