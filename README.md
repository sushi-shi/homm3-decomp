...
**Executable matched: 31.99%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,495 / 4,748 functions exact (31.5%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1426 / 1813 (78.7%) |  85.45% |    85.45% |
