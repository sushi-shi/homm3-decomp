...
**Executable matched: 59.71%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,505 / 4,765 functions exact (52.6%) across the full engine (3067 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2436 / 2998 (81.3%) |  92.12% |    92.12% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,698 (0.0%) |    0.0% |      0.0% |
