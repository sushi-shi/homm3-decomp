...
**Executable matched: 89.61%** — fuzzy-weighted bytes over all 1,998,615 unfiltered bytes.

**Match score** — 3,637 / 4,764 functions exact (76.3%) across the full engine (4331 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3568 / 4262 (83.7%) |  95.44% |    95.96% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 433 (0.0%) |    0.0% |      0.0% |
