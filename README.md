...
**Executable matched: 18.91%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,102 / 4,748 functions exact (23.2%) across the full engine (1476 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1033 / 1407 (73.4%) |  62.78% |    62.78% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,272 (0.0%) |    0.0% |      0.0% |
