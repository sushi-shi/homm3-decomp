...
**Match score** — 1,969 / 4,750 functions exact (41.5%) across the full engine (2389 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1900 / 2320 (81.9%) |  96.59% |    96.59% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,361 (0.0%) |    0.0% |      0.0% |
