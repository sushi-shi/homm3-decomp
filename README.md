...
**Executable matched: 17.13%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,139 / 4,748 functions exact (24.0%) across the full engine (1514 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1070 / 1445 (74.0%) |  60.04% |    60.04% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,234 (0.0%) |    0.0% |      0.0% |
