...
**Executable matched: 77.86%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,891 / 4,772 functions exact (60.6%) across the full engine (3538 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2822 / 3469 (81.3%) |  94.62% |    95.19% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,234 (0.0%) |    0.0% |      0.0% |
