...
**Executable matched: 78.04%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,877 / 4,772 functions exact (60.3%) across the full engine (3534 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2808 / 3465 (81.0%) |  94.62% |    95.19% |
