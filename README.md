...
**Executable matched: 95.37%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 4,028 / 4,765 functions exact (84.5%) across the full engine (4713 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3959 / 4644 (85.2%) | 3980 / 4644 (85.7%) |  96.34% |    96.51% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 52 (0.0%) |       0 / 52 (0.0%) |    0.0% |      0.0% |
