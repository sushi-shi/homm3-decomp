...
**Executable matched: 89.73%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,675 / 4,765 functions exact (77.1%) across the full engine (4361 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   132 | 3606 / 4292 (84.0%) |  95.49% |    96.00% |
