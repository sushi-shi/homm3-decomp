...
**Executable matched: 78.98%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,924 / 4,772 functions exact (61.3%) across the full engine (3590 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   123 | 2855 / 3521 (81.1%) |  94.60% |    95.17% |
