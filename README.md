...
**Executable matched: 19.31%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,107 / 4,748 functions exact (23.3%) across the full engine (1488 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1038 / 1419 (73.2%) |  63.20% |    63.20% |
