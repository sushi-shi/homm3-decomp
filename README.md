...
**Executable matched: 31.81%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,482 / 4,748 functions exact (31.2%) across the full engine (1849 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1413 / 1780 (79.4%) |  88.83% |    88.83% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,899 (0.0%) |    0.0% |      0.0% |
