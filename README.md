...
**Executable matched: 57.87%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,473 / 4,765 functions exact (51.9%) across the full engine (3055 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2404 / 2986 (80.5%) |  89.57% |    89.57% |
