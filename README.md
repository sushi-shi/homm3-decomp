...
**Executable matched: 85.25%** — fuzzy-weighted bytes over all 1,998,047 unfiltered bytes.

**Match score** — 3,273 / 4,772 functions exact (68.6%) across the full engine (3983 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   126 | 3204 / 3914 (81.9%) |  95.09% |    95.67% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 789 (0.0%) |    0.0% |      0.0% |
