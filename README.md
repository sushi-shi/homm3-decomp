...
**Match score** — 3,797 / 4,763 functions exact (79.7%) across the full engine (4464 in linked units).

**Function exact MAX** — 3,837 / 4,763 functions (80.6%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3728 / 4395 (84.8%) | 3768 / 4395 (85.7%) |  96.08% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 299 (0.0%) |      0 / 299 (0.0%) |    0.0% |      0.0% |
