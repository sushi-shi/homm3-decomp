...
**Executable matched: 87.65%** — fuzzy-weighted bytes over all 1,998,049 unfiltered bytes.

**Match score** — 3,425 / 4,770 functions exact (71.8%) across the full engine (4148 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   127 | 3356 / 4079 (82.3%) |  95.23% |    95.76% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 622 (0.0%) |    0.0% |      0.0% |
