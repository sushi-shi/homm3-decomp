...
**Executable matched: 19.18%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,104 / 4,748 functions exact (23.3%) across the full engine (1483 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1035 / 1414 (73.2%) |  63.03% |    63.03% |
