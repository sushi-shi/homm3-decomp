...
**Executable matched: 3.73%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 292 / 4,749 functions exact (6.1%) across the full engine (694 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 223 / 625 (35.7%) |  26.37% |    26.37% |
| `zlib-1.1.3`  |    14 |  69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |  0 / 4,055 (0.0%) |    0.0% |      0.0% |
