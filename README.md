...
**Executable matched: 45.47%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,123 / 4,750 functions exact (44.7%) across the full engine (2541 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2054 / 2472 (83.1%) |  96.68% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,209 (0.0%) |    0.0% |      0.0% |
