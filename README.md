...
**Executable matched: 4.61%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 395 / 4,749 functions exact (8.3%) across the full engine (805 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 326 / 736 (44.3%) |  30.30% |    30.30% |
| `zlib-1.1.3`  |    14 |  69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |  0 / 3,944 (0.0%) |    0.0% |      0.0% |
