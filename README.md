...
**Match score** — 3,810 / 4,763 functions exact (80.0%) across the full engine (4480 in linked units).

**Function exact MAX** — 3,852 / 4,763 functions (80.9%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3741 / 4411 (84.8%) | 3783 / 4411 (85.8%) |  96.08% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 283 (0.0%) |      0 / 283 (0.0%) |    0.0% |      0.0% |
