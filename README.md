...
**Function exact MAX** — 4,275 / 4,766 current implementations (89.7%) have reached 100%.

**CUR diagnostics** — 4,204 / 4,766 functions exact (88.2%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3539 / 3989 (88.7%) | 3595 / 3989 (90.1%) |    97.22% |    97.54% |
