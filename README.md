...
**Executable matched: 94.35%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,990 / 4,765 functions exact (83.7%) across the full engine (4659 in linked units).
...
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3921 / 4590 (85.4%) | 3932 / 4590 (85.7%) |  96.26% |    96.38% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 106 (0.0%) |      0 / 106 (0.0%) |    0.0% |      0.0% |
