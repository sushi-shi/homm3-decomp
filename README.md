...
**Executable matched: 43.34%** — fuzzy-weighted bytes over all 1,996,081 unfiltered bytes.

**Match score** — 1,915 / 4,749 functions exact (40.3%) across the full engine (2330 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1846 / 2261 (81.6%) |  96.59% |    96.59% |
