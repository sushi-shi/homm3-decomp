...
**Executable matched: 95.93%** — fuzzy-weighted bytes over all 1,998,996 unfiltered bytes.

**Match score** — 4,119 / 4,766 functions exact (86.4%) across the full engine (4766 in linked units).

**Function exact MAX** — 4,185 / 4,766 current implementations (87.8%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4050 / 4697 (86.2%) | 4116 / 4697 (87.6%) |  95.88% |    96.43% |
