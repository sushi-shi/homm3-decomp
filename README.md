...
**Match score** — 2,925 / 4,772 functions exact (61.3%) across the full engine (3593 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   124 | 2856 / 3524 (81.0%) |  94.27% |    94.87% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,179 (0.0%) |    0.0% |      0.0% |
