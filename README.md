...
**Executable matched: 61.50%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,586 / 4,765 functions exact (54.3%) across the full engine (3110 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2517 / 3041 (82.8%) |  93.14% |    93.32% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,655 (0.0%) |    0.0% |      0.0% |
