...
**Executable matched: 35.75%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,523 / 4,748 functions exact (32.1%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1454 / 1813 (80.2%) |  95.89% |    95.89% |
