...
**Match score** — 4,074 / 4,764 functions exact (85.5%) across the full engine (4764 in linked units).

**Function exact MAX** — 4,095 / 4,764 current implementations (86.0%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4005 / 4695 (85.3%) | 4026 / 4695 (85.8%) |  96.34% |    96.56% |
