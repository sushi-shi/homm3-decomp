...
**Executable matched: 74.76%** — fuzzy-weighted bytes over all 1,997,934 unfiltered bytes.

**Match score** — 2,793 / 4,770 functions exact (58.6%) across the full engine (3430 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   121 | 2724 / 3361 (81.0%) |  93.19% |    93.81% |
