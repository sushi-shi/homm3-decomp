...
**Match score** — 4,124 / 4,766 functions exact (86.5%) across the full engine (4766 in linked units).

**Function exact MAX** — 4,189 / 4,766 current implementations (87.9%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4055 / 4697 (86.3%) | 4120 / 4697 (87.7%) |  95.94% |    96.47% |
