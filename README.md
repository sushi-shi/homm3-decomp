...
**Executable MAX: 97.06%** — weighted by function size across 1,998,996 bytes of code included in matching.

**Function exact MAX** — 4,253 / 4,766 current implementations (89.2%) have reached 100%.

**CUR diagnostics** — 4,189 / 4,766 functions exact (87.9%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3524 / 3989 (88.3%) | 3573 / 3989 (89.6%) |    96.86% |    97.20% |
