...
**Match score** — 3,793 / 4,763 functions exact (79.6%) across the full engine (4460 in linked units).

**Function exact MAX** — 3,833 / 4,763 functions (80.5%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3724 / 4391 (84.8%) | 3764 / 4391 (85.7%) |  96.07% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 303 (0.0%) |      0 / 303 (0.0%) |    0.0% |      0.0% |
