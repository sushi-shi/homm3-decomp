...
**Function exact MAX** — 4,229 / 4,766 current implementations (88.7%) have reached 100%.

**CUR diagnostics** — 4,161 / 4,766 functions exact (87.3%) in this build (4764 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module        | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :------------ | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`        |   138 | 4160 / 4695 (88.6%) | 4092 / 4695 (87.2%) |    96.83% |    96.37% |
