...
**Executable matched: 82.47%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 3,092 / 4,772 functions exact (64.8%) across the full engine (3786 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   126 | 3023 / 3717 (81.3%) |  94.95% |    95.50% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 986 (0.0%) |    0.0% |      0.0% |
