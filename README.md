...
**Executable MAX: 97.08%** — weighted by function size across 1,999,184 bytes of code included in matching.

**Function exact MAX** — 4,273 / 4,769 current implementations (89.6%) have reached 100%.

_CUR / MAX / HIST: 4,202 / 4,273 / 4,386 exact; 96.56% / 97.08% / 98.25% weighted fuzzy. CUR is this build; HIST retains peaks from earlier source implementations. Unchanged-source CUR dips do not lower MAX._

| Module       | Units | Functions exact MAX | Fuzzy MAX |
| :----------- | ----: | ------------------: | --------: |
| `game`       |   123 | 3594 / 3991 (90.1%) |    97.28% |
| `rmg`        |     3 |   301 / 368 (81.8%) |    94.37% |
| `network`    |     4 |   269 / 281 (95.7%) |    97.95% |
...
**Lightly optimized Classic Mac PowerPC reference (last full checkpoint):** 418 / 1019 scored functions exact; 59.30% of 228,072 compared bytes match. Scored functions are source claims whose full-TU body links; this is coverage, not the whole Mac game.
