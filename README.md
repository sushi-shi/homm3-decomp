...
**Function exact MAX** — 4,248 / 4,766 current implementations (89.1%) have reached 100%.

**CUR diagnostics** — 4,185 / 4,766 functions exact (87.8%) in this build (4766 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module       | Units | Functions exact CUR |  Function exact MAX | Fuzzy CUR | Fuzzy MAX |
| :----------- | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`       |   123 | 3520 / 3989 (88.2%) | 3568 / 3989 (89.4%) |    96.82% |    97.16% |
