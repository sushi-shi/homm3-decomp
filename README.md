...
**Executable MAX: 96.50%** — MAX-weighted bytes over all 1,998,996 unfiltered bytes.

**Function exact MAX** — 4,195 / 4,766 current implementations (88.0%) have reached 100%.

**CUR diagnostics** — 4,125 / 4,766 functions exact (86.6%) in this build (4768 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module        | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :------------ | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`        |   138 | 4126 / 4699 (87.8%) | 4056 / 4699 (86.3%) |    96.45% |    95.99% |
