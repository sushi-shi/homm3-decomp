...
**Executable matched: 16.32%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,099 / 4,748 functions exact (23.1%) across the full engine (1474 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1030 / 1405 (73.3%) |  58.78% |    58.78% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 3,274 (0.0%) |    0.0% |      0.0% |
