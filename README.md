...
**Match score** — 4,099 / 4,765 functions exact (86.0%) across the full engine (4765 in linked units).

**Function exact MAX** — 4,165 / 4,765 current implementations (87.4%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4030 / 4696 (85.8%) | 4096 / 4696 (87.2%) |  95.90% |    96.49% |
