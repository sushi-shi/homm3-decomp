...
**Executable matched: 31.64%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,481 / 4,748 functions exact (31.2%) across the full engine (1849 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1412 / 1780 (79.3%) |  88.36% |    88.36% |
