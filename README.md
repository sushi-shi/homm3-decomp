...
**Executable matched: 60.52%** — fuzzy-weighted bytes over all 1,997,013 unfiltered bytes.

**Match score** — 2,510 / 4,765 functions exact (52.7%) across the full engine (3079 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2441 / 3010 (81.1%) |  92.66% |    92.66% |
