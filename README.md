...
**Executable matched: 45.55%** — fuzzy-weighted bytes over all 1,996,217 unfiltered bytes.

**Match score** — 2,129 / 4,750 functions exact (44.8%) across the full engine (2547 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2060 / 2478 (83.1%) |  96.69% |    96.69% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,203 (0.0%) |    0.0% |      0.0% |
