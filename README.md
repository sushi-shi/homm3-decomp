...
**Executable matched: 7.91%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 595 / 4,749 functions exact (12.5%) across the full engine (983 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 526 / 914 (57.5%) |  37.63% |    37.63% |
