...
**Executable matched: 94.43%** — fuzzy-weighted bytes over all 1,998,847 unfiltered bytes.

**Match score** — 3,993 / 4,765 functions exact (83.8%) across the full engine (4668 in linked units).

**Function exact MAX** — 4,008 / 4,765 current implementations (84.1%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3924 / 4599 (85.3%) | 3939 / 4599 (85.6%) |  96.25% |    96.41% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |       0 / 97 (0.0%) |       0 / 97 (0.0%) |    0.0% |      0.0% |
