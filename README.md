...
**Executable matched: 84.96%** — fuzzy-weighted bytes over all 1,998,047 unfiltered bytes.

**Match score** — 3,242 / 4,772 functions exact (67.9%) across the full engine (3951 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   126 | 3173 / 3882 (81.7%) |  95.09% |    95.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 821 (0.0%) |    0.0% |      0.0% |
