...
**Executable matched: 76.81%** — fuzzy-weighted bytes over all 1,998,017 unfiltered bytes.

**Match score** — 2,860 / 4,772 functions exact (59.9%) across the full engine (3497 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   122 | 2791 / 3428 (81.4%) |  94.13% |    94.71% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 1,275 (0.0%) |    0.0% |      0.0% |
