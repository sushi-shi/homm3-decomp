...
**Executable matched: 15.82%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,059 / 4,748 functions exact (22.3%) across the full engine (1417 in linked units).

| Module        | Units |    Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | -----------------: | ------: | --------: |
| `game`        |   117 | 990 / 1348 (73.4%) |  58.51% |    58.51% |
| `zlib-1.1.3`  |    14 |   69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |   0 / 3,331 (0.0%) |    0.0% |      0.0% |
