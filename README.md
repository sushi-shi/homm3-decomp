...
**Match score** — 1,982 / 4,750 functions exact (41.7%) across the full engine (2561 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1913 / 2492 (76.8%) |  85.48% |    85.48% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,189 (0.0%) |    0.0% |      0.0% |
