...
**Executable matched: 89.61%** — fuzzy-weighted bytes over all 1,998,778 unfiltered bytes.

**Match score** — 3,638 / 4,765 functions exact (76.3%) across the full engine (4341 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   131 | 3569 / 4272 (83.5%) |  95.40% |    95.91% |
