...
**Executable matched: 35.70%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,521 / 4,748 functions exact (32.0%) across the full engine (1886 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1452 / 1817 (79.9%) |  95.47% |    95.47% |
