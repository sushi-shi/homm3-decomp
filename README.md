...
**Executable MAX: 96.85%** — MAX-weighted bytes over all 1,998,996 unfiltered bytes.

**Function exact MAX** — 4,225 / 4,766 current implementations (88.6%) have reached 100%.

**CUR diagnostics** — 4,157 / 4,766 functions exact (87.2%) in this build (4764 in linked units). Compiler-context dips with held MAX do not reduce matching progress.

| Module        | Units |  Function exact MAX | Functions exact CUR | Fuzzy MAX | Fuzzy CUR |
| :------------ | ----: | ------------------: | ------------------: | --------: | --------: |
| `game`        |   138 | 4156 / 4695 (88.5%) | 4088 / 4695 (87.1%) |    96.82% |    96.36% |
