...
**Executable matched: 6.34%** — fuzzy-weighted bytes over all 1,996,135 unfiltered bytes.

**Match score** — 559 / 4,749 functions exact (11.8%) across the full engine (978 in linked units).

| Module        | Units |   Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ----------------: | ------: | --------: |
| `game`        |    38 | 490 / 909 (53.9%) |  28.94% |    28.94% |
