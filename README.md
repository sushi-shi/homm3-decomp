...
**Executable matched: 49.23%** — fuzzy-weighted bytes over all 1,996,542 unfiltered bytes.

**Match score** — 2,271 / 4,753 functions exact (47.8%) across the full engine (2706 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2202 / 2637 (83.5%) |  96.71% |    96.71% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,047 (0.0%) |    0.0% |      0.0% |
