...
**Executable matched: 48.72%** — fuzzy-weighted bytes over all 1,996,518 unfiltered bytes.

**Match score** — 2,228 / 4,755 functions exact (46.9%) across the full engine (2661 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 2159 / 2592 (83.3%) |  96.76% |    96.76% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |    0 / 2,094 (0.0%) |    0.0% |      0.0% |
