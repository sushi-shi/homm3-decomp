...
**Match score** — 3,764 / 4,763 functions exact (79.0%) across the full engine (4424 in linked units).

**Function exact MAX** — 3,796 / 4,763 functions (79.7%) have reached 100%.

| Module        | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`        |   132 | 3695 / 4355 (84.8%) | 3727 / 4355 (85.6%) |  96.08% |    96.68% |
| `zlib-1.1.3`  |    14 |    69 / 69 (100.0%) |    69 / 69 (100.0%) | 100.00% |   100.00% |
| `(unmatched)` |     — |      0 / 339 (0.0%) |      0 / 339 (0.0%) |    0.0% |      0.0% |
