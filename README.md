...
**Match score** — 4,129 / 4,766 functions exact (86.6%) across the full engine (4766 in linked units).

**Function exact MAX** — 4,194 / 4,766 current implementations (88.0%) have reached 100%.

| Module       | Units |     Functions exact |  Function exact MAX |   Fuzzy | Fuzzy Max |
| :----------- | ----: | ------------------: | ------------------: | ------: | --------: |
| `game`       |   138 | 4060 / 4697 (86.4%) | 4125 / 4697 (87.8%) |  95.99% |    96.52% |
