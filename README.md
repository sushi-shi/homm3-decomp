...
**Executable matched: 33.40%** — fuzzy-weighted bytes over all 1,996,012 unfiltered bytes.

**Match score** — 1,509 / 4,748 functions exact (31.8%) across the full engine (1882 in linked units).

| Module        | Units |     Functions exact |   Fuzzy | Fuzzy Max |
| :------------ | ----: | ------------------: | ------: | --------: |
| `game`        |   117 | 1440 / 1813 (79.4%) |  89.35% |    89.35% |
