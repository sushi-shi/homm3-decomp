...
// type_artifact this pointer.
    ...
    void getRolloverText(char* buffer);
};
...
public:
    ...
    // Before normalization (function): hero::get_equipped_artifacts.
    long getEquippedArtifacts(unsigned char countWarMachines);
    // Before normalization (function): hero::get_number_in_backpack.
    ...
    // Before normalization (function): hero::get_artifact.
    const type_artifact* getArtifact(long slot) const
    {
        return &m_equipped[slot];
    }
    // Before normalization (function): hero::get_artifact.
    type_artifact* getArtifact(long slot)
    {
        return &m_equipped[slot];
    }
    // Before normalization (function): hero::get_backpack.
    const type_artifact* getBackpack(long slot) const
    {
        return &m_backpack[slot];
    }
    // Before normalization (function): hero::get_backpack.
    type_artifact* getBackpack(long slot)
    {
        return &m_backpack[slot];
    }
