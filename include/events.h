...
enum EAdventureEventText {
    ...
    ADV_EVENT_TEXT_BLACK_BOX_LOSE_MORALE_FORMAT = 178,
    ADV_EVENT_TEXT_BLACK_BOX_GAIN_MORALE_FORMAT = 179,
    ADV_EVENT_TEXT_BLACK_BOX_LOSE_LUCK_FORMAT = 180,
    ADV_EVENT_TEXT_BLACK_BOX_GAIN_LUCK_FORMAT = 181,
    ADV_EVENT_TEXT_BLACK_BOX_LOSE_TREASURE_FORMAT = 182,
    ADV_EVENT_TEXT_BLACK_BOX_GAIN_TREASURE_FORMAT = 183,
