...
- [ ] Review [compiler warnings](../tooling/compiler-warnings.md), including
...
- [ ] Review inlining pragmas: **388 directives**, including resets,
  ...
  See the [union and pragma audit](../reconstruction/union-pragma-audit.md).
- [ ] Search for inline functions.

## Completed reviews

- [x] Artificial address arithmetic:
  [audit and retained arithmetic](../reconstruction/address-arithmetic-audit.md).
- [x] Owner recovery from member pointers:
  [owner-pointer audit](../reconstruction/owner-pointer-audit.md).
- [x] Out-of-object pointers:
  [repairs and allocation proofs](../reconstruction/pointer-boundary-repairs.md).
- [x] Preprocessor cleanup and shared-code macro search:
  **36 → 1 `#define` directive** in `src/`;
  [audit and retained macro](../reconstruction/preprocessor-audit.md).
