...
contract is documented in `docs/matching/source-ownership.md`; 98 focused and existing
...
The [provenance investigation](../reference/rmg-voronoi-provenance.md) compares retail
...
[`homm3 hypotheses` runner](../matching/source-hypotheses.md) also records every scored
