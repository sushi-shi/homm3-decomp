# Recovered field layouts

The starting population is the 332 declarations left by the naming pass in
[name-normalization.md](../matching/naming.md). This reference records recovered members, retained unknown storage, and the
retail evidence for their extents. The active backlog is
[unresolved data fields](../todos/unresolved-data-fields.md).
